import { getRuntimeExtraHeadersSync, refreshLocalRuntimeUrlAuthToken, refreshRuntimeUrlAuthToken, setRuntimeBearerToken, setRuntimeExtraHeaders } from '@ivaldi/ui/lib/runtime-auth';
import { installRuntimeFetchBridge } from '@ivaldi/ui/lib/runtime-fetch';
...
import { getInjectedBootOutcome } from '@ivaldi/ui/lib/desktopBoot';
import { configureRuntimeUrlResolver } from '@ivaldi/ui/lib/runtime-url';
import type { EmbeddedSessionRuntimeBootstrap } from '@ivaldi/ui/components/layout/contextPanelEmbeddedChat';
