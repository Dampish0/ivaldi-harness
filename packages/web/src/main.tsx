...
import { resolveHostedSurface, watchHostedSurfaceViewport, type HostedSurface } from '@ivaldi/ui/lib/runtimeSurface';
import {
  isEmbeddedSessionChat,
  requestEmbeddedSessionRuntimeBootstrap,
} from '@ivaldi/ui/components/layout/contextPanelEmbeddedChat';
...
const start = async (): Promise<void> => {
  ...
  if (hostedSurface === 'mobile') {
    const { renderMobileApp } = await import('@ivaldi/ui/apps/renderMobileApp');
