...
import { registerExecutionBoundaryRoutes } from '../execution-boundary/routes.js';
import { registerLifecycleHookRoutes } from '../lifecycle-hooks/routes.js';
...
export const createFeatureRoutesRuntime = (dependencies) => {
  ...
  const registerRoutes = async (app, routeDependencies) => {
    ...
    registerExecutionBoundaryRoutes(app, executionBoundaryRuntime);
    registerLifecycleHookRoutes(app, {
      lifecycleHookRuntime,
      persistSettings,
      management: lifecycleHookManagementService,
    });
