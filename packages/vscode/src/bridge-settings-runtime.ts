...
const OPENCHAMBER_SHARED_SETTINGS_PATH = path.join(resolveIvaldiDataDirectory(), 'settings.json');
const OPENCHAMBER_MAGIC_PROMPTS_PATH = path.join(resolveIvaldiDataDirectory(), 'magic-prompts.json');
