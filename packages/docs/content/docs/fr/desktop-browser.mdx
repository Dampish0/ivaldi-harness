...
**Effacer les cookies** et **Effacer les données en cache** ne concernent que ce panneau. Votre session Ivaldi et les autres fenêtres n'y touchent pas.
...
Les actions du navigateur constituent l'**outil Ivaldi Web**, qui s'active et se désactive séparément dans **Réglages → Général → Outils Ivaldi**.
