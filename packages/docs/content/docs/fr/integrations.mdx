...
Une intégration est un petit plugin qui ajoute un fournisseur à Ivaldi à partir d'un abonnement que tu possèdes déjà. Tu les gères dans **Settings → Integrations**.
...
Cursor rend disponibles dans Ivaldi les modèles inclus dans ton plan Cursor.
