...
Uma integração é um pequeno plugin que adiciona um provedor ao Ivaldi usando uma assinatura que você já tem. Você as gerencia em **Settings → Integrations**.
...
O Cursor torna disponíveis no Ivaldi os modelos incluídos no seu plano Cursor.
