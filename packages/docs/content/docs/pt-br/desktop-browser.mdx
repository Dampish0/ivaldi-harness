...
**Limpar cookies** e **Limpar dados em cache** valem só para este painel. Sua sessão do Ivaldi e as outras janelas ficam intactas.
...
As ações do navegador são a **ferramenta Ivaldi Web**, que pode ser ligada e desligada por conta própria em **Configurações → Geral → Ferramentas do Ivaldi**.
