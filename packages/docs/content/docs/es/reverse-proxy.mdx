---
title: Proxy inverso
description: Configura Ivaldi correctamente detrás de Nginx, Nginx Proxy Manager u otro proxy inverso.
---

# Proxy inverso

Usa esta página si ejecutas Ivaldi detrás de Nginx, Nginx Proxy Manager, Caddy, Cloudflare u otro proxy inverso.

## Antes de ponerle un proxy

1. Confirma primero que Ivaldi funciona directamente.
...
- Desactiva gzip en el proxy si Ivaldi ya comprime las respuestas.
...
- Ivaldi accesible directamente en la LAN
...
- Ivaldi comprime las respuestas HTTP con gzip (umbral de 1 KB).
...
Las rutas de streaming SSE están excluidas de la compresión por Ivaldi, pero la CDN aún puede almacenarlas en búfer. Consulta la documentación de tu CDN para saber cómo desactivar el búfer en las rutas SSE.
