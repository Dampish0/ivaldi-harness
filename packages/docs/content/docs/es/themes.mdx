---
title: Temas
description: Personaliza Ivaldi con temas integrados y definidos por el usuario.
---

# Temas

Ivaldi admite temas integrados y archivos JSON de tema personalizados.
...
3. Abre Ivaldi y ve a **Settings -> Theme -> Reload themes**.
