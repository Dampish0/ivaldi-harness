...
**Borrar cookies** y **Borrar datos en caché** afectan únicamente a este panel. Tu sesión de Ivaldi y cualquier otra ventana quedan intactas.
...
Las acciones del navegador son la **herramienta Ivaldi Web**, que se activa y desactiva por separado en **Ajustes → General → Herramientas de Ivaldi**.
