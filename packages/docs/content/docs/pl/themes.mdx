---
title: Motywy
description: Dostosuj Ivaldi za pomocą wbudowanych i własnych motywów.
---

# Motywy

Ivaldi obsługuje wbudowane motywy oraz własne pliki JSON z motywami.
...
3. Otwórz Ivaldi, a następnie przejdź do **Settings -> Theme -> Reload themes**.
