...
**Wyczyść ciasteczka** i **Wyczyść dane w pamięci podręcznej** dotyczą wyłącznie tego panelu. Twoja sesja Ivaldi i pozostałe okna zostają nietknięte.
...
Działania w przeglądarce to **narzędzie Ivaldi Web**, które włącza się i wyłącza osobno w **Ustawienia → Ogólne → Narzędzia Ivaldi**.
