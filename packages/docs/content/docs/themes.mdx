---
title: Themes
description: Customize Ivaldi with built-in and user-defined themes.
---

# Themes

Ivaldi supports built-in themes and custom theme JSON files.
...
3. Open Ivaldi, then go to **Settings -> Theme -> Reload themes**.
