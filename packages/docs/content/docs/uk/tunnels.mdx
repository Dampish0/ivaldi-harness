---
title: Тунелі
description: Безпечно відкрийте Ivaldi для віддаленого та мобільного доступу.
---

# Тунелі

Тунель — це публічне посилання на ваш Ivaldi, щоб дістатися до нього зі звичайного браузера в іншій мережі. Скористайтеся `openchamber tunnel`, щоб створити його для запущеного інстансу.
...
Ivaldi запускає CLI провайдера тунелю на вашій машині. Спочатку встановіть провайдера, який хочете використовувати:
...
Коли тунель піднято, `status` показує публічний URL. Відкрийте його або відскануйте QR-код, щоб дістатися до Ivaldi звідусіль.

Типово Ivaldi виводить QR-код в інтерактивних TTY-сесіях. Використовуйте `--qr`, щоб примусово вивести QR, або `--no-qr`, щоб вимкнути його.
...
- один активний тунель на інстанс Ivaldi (порт)
...
- [PWA та мобільний доступ](/uk/mobile/) — відкривайте Ivaldi з телефона
