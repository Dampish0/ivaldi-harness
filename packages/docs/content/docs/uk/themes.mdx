---
title: Теми
description: Налаштуйте Ivaldi за допомогою вбудованих і власних тем.
---

# Теми

Ivaldi підтримує вбудовані теми та власні JSON-файли тем.
...
3. Відкрийте Ivaldi, потім перейдіть до **Settings -> Theme -> Reload themes**.
