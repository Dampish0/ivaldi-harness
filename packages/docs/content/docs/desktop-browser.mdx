...
**Clear cookies** and **Clear cached data** apply to this panel alone. Your Ivaldi session and any other window are untouched.
...
The browser actions are the **Ivaldi Web tool**, which can be turned on and off on its own in **Settings → General → Ivaldi Tools**.
