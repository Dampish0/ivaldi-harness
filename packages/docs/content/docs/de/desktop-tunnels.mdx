...
Die Desktop-App kann unter **Settings → Ivaldi → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du Ivaldi nicht per CLI starten.

## Anbieter installieren

Ivaldi startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → Ivaldi → Tunnel**.
