---
title: Schnellstart
description: Starte Ivaldi schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das Ivaldi-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
...
Du solltest die Ivaldi-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
