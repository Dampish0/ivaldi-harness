...
**Cookies löschen** und **Zwischengespeicherte Daten löschen** gelten allein für dieses Panel. Deine Ivaldi-Sitzung und andere Fenster bleiben unberührt.
...
Die Browser-Aktionen sind das **Ivaldi-Web-Werkzeug**, das sich unter **Einstellungen → Allgemein → Ivaldi-Werkzeuge** einzeln ein- und ausschalten lässt.
