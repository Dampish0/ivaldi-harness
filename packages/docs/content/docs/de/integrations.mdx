...
Eine Integration ist ein kleines Plugin, das Ivaldi einen Provider hinzufügt — auf Basis eines Abos, das du bereits hast. Verwalten kannst du sie unter **Settings → Integrations**.
...
Cursor macht die Modelle deines Cursor-Plans in Ivaldi nutzbar.
