---
title: Reverse Proxy
description: Konfigurieren Sie Ivaldi korrekt hinter Nginx, Nginx Proxy Manager oder einem anderen Reverse Proxy.
---

# Reverse Proxy

Nutzen Sie diese Seite, wenn Ivaldi hinter Nginx, Nginx Proxy Manager, Caddy, Cloudflare oder einem anderen Reverse Proxy läuft.

## Bevor Sie es proxyen

1. Bestätigen Sie zuerst, dass Ivaldi direkt funktioniert.
...
- Deaktivieren Sie gzip auf dem Proxy, wenn Ivaldi Antworten bereits komprimiert.
...
- Ivaldi direkt im LAN erreichbar
...
- Ivaldi komprimiert HTTP-Antworten mit gzip (Schwelle 1 KB).
...
SSE-Streaming-Routen sind von Ivaldi von der Komprimierung ausgeschlossen, das CDN kann sie aber trotzdem puffern. Prüfen Sie in der CDN-Dokumentation, wie sich Buffering auf SSE-Pfaden deaktivieren lässt.
