  ...
  return (
    <div ref={wrapperRef} className="fixed inset-x-0 bottom-0 top-[calc(var(--oc-safe-area-top,0px)+var(--oc-header-height,56px))] z-20 pointer-events-none">
      <div
        ...
        className={cn(
          'overflow-y-auto overscroll-contain rounded-md border border-border/50 bg-[var(--surface-elevated)] p-1.5 will-change-transform',
...
const MobileUsageLimits: React.FC<{
  ...
  return (
    <div className="pt-1.5">
      <div className="flex min-w-0 items-center gap-2.5 px-2 pb-1">
        <span className="flex size-5 shrink-0 items-center justify-center text-muted-foreground">
      ...
      <UsageProviderCards
        ...
        timeFormatPreference={timeFormatPreference}
        className="space-y-0 [&>div]:rounded-none [&>div]:bg-transparent [&>div]:px-2 [&>div]:py-2 [&>div+div]:border-t [&>div+div]:border-border/40"
      />
    </div>
  );
};
