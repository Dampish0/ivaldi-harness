      ...
      <div className="flex-1 overflow-y-auto px-5 py-4">
        <div className="space-y-6">
          {connections.length > 0 ? (
            <div {...debugLongPress} className="overflow-hidden border-y border-border/60">
              {connections.map((connection) => {
                ...
                return (
                  ...
                  >
                    <button
                      type="button"
                      className="flex min-h-12 min-w-0 flex-1 items-center gap-2.5 px-1 py-2.5 text-left transition-colors hover:bg-interactive-hover/40 active:bg-interactive-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--interactive-focus-ring)] disabled:opacity-60"
                      onClick={() => {
                        if (isActive) return;
                    ...
                    >
                      <span className="relative flex size-8 shrink-0 items-center justify-center text-muted-foreground">
                        <Icon name="server" className="size-[18px]" />
                        {isActive ? (
                          <span className="absolute right-0 top-0 size-2 rounded-full bg-[var(--status-success)]" aria-hidden />
                        ) : null}
                      </span>
