        ...
        return (
                ...
                <div className="space-y-1">
                    <button
                        type="button"
                        className={cn(
                            'flex w-full items-center justify-between rounded-md px-2 py-2 text-left transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--interactive-focus-ring)]',
                            !agentName
                    ...
                    >
                        ...
                        {!agentName && <Icon name="check" className="size-4 shrink-0 text-foreground" />}
                    </button>
                    {agents.map((agent) => {
                        ...
                        return (
                            ...
                            >
                                <div className="flex flex-col">
                                    ...
                                    {agent.description && (
                                        <span className="typography-micro line-clamp-2 text-muted-foreground">
                                            {agent.description}
                                        </span>
                                    )}
                                </div>
