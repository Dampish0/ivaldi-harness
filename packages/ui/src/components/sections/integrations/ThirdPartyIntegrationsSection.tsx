  ...
  const renderPlugin = (plugin: ThirdPartyPluginDefinition) => {
    ...
    return (
      ...
      >
        ...
        >
          <CollapsibleTrigger
            className="flex w-full min-w-0 items-center gap-3 rounded-none px-1 py-3 text-left hover:bg-interactive-hover/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--interactive-focus-ring)]"
          >
            ...
            <span
              aria-live="polite"
              className={cn(
                'max-w-36 shrink-0 truncate typography-micro font-medium',
                statusClassName,
              )}
            >
              {status}
  ...
  return (
    <>
      <SettingsSection
        ...
        contentClassName="divide-y divide-[var(--interactive-border)]"
      >
