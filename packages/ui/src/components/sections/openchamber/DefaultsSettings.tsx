    ...
    <>
      <SettingsSection
        title={isDeveloperMode
          ? t('settings.openchamber.defaults.title')
          : t('settings.page.work.ai.defaultsTitle')}
        divider={false}
          ...
          <div>
            ...
            <SettingsFieldRow
              ...
              label={isDeveloperMode
                ...
                : t('settings.openchamber.defaults.field.defaultAssistant')}
            >
              <AgentSelector
          ...
          <>
            ...
            <div className="space-y-1">
              <SettingsCheckboxRow
                ...
                info={t('settings.openchamber.defaults.smallModel.description')}
              />
            ...
            <SettingsFieldRow
              ...
              label={t('settings.openchamber.defaults.walkthroughModel.title')}
              info={t('settings.openchamber.defaults.walkthroughModel.description')}
            >
              <ModelSelector
