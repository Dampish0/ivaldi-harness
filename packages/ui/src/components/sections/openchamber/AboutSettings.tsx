...
const GITHUB_URL = 'https://github.com/Dampish0/ivaldi-harness';
  ...
  if (isMobile) {
    return (
      <div className="w-full space-y-6 pb-2">
        ...
        {updateStore.error && (
          <p className="rounded-md border border-[var(--status-error-border)] bg-[var(--status-error-background)] px-3 py-2 typography-meta text-[var(--status-error)]">
            {updateStore.error}
          </p>
        )}
