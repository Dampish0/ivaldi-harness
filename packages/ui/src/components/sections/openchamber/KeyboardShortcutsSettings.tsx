...
import { isShortcutVisibleInProductMode } from '@/lib/productMode';
...
export const KeyboardShortcutsSettings: React.FC = () => {
  ...
  const actions = React.useMemo(() => {
    const all = getCustomizableShortcutActions().filter((action) => isShortcutVisibleInProductMode(productMode, action.id));
