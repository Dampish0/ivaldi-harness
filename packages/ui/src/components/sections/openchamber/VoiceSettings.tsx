...
const LocalModelPicker = ({
    ...
    return (
        <div
            ...
            className={cn(
                'mt-1.5 w-full',
                isMobile ? 'flex flex-col gap-0.5' : 'grid grid-cols-1 gap-3 @xl:grid-cols-2',
            )}
        >
                                ...
                                <div className="min-w-0 flex-1 space-y-2">
                                    <div className="flex flex-wrap items-center gap-2">
                                        <span className={cn(
                                            ...
                                            isMobile || selected ? 'text-foreground' : 'text-foreground/50',
                                        )}>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className={cn('relative', SETTINGS_CONTROL_CLUSTER_CLASS)}>
                                        <Input
                                            ...
                                            placeholder="sk-..."
                                            className="h-8 rounded-md bg-transparent px-3 pr-8 typography-ui-label"
                                        />
                                        {openaiApiKey && (
                                            <Button
                                                variant="ghost"
                                                ...
                                                className="absolute right-1 top-1/2 -translate-y-1/2 px-1 text-muted-foreground"
                                            >
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="space-y-1.5">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span className={SETTINGS_HELPER_CLASS}>{t('settings.voice.page.field.optional')}</span>
                                        </div>
                                        <div className={cn('relative', SETTINGS_CONTROL_CLUSTER_CLASS)}>
                                            <Input
                                                type="password"
