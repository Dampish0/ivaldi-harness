...
const DEFAULT_PWA_INSTALL_NAME = 'Ivaldi - AI Coding Assistant';
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            ...
                            {showPwaOrientationSetting && (
                                <SettingsFieldRow
                                    ...
                                    info={t('settings.openchamber.visual.field.installOrientationHint')}
                        ...
                        {showBehaviorDisplaySettings && (
                            ...
                            >
                                {shouldShow('chatRenderMode') && (
                                    ...
                                    >
                                        <SettingsRadioGroup aria-label={t('settings.openchamber.visual.section.chatRenderModeAria')}>
                                            {CHAT_RENDER_MODE_OPTIONS.map((option) => (
                                                <SettingsRadioOption
                                                    key={option.id}
                                                    selected={chatRenderMode === option.id}
                                                    onSelect={() => handleChatRenderModeChange(option.id)}
                                                    label={tUnsafe(option.labelKey)}
                                                    description={option.descriptionKey ? tUnsafe(option.descriptionKey) : undefined}
                                                    ariaLabel={tUnsafe(option.labelKey)}
                                                />
                                            ))}
                                        </SettingsRadioGroup>
