...
export const ProvidersPage: React.FC = () => {
  ...
  if (!isAddMode && providers.length === 0) {
    return (
      <SettingsPageLayout
        ...
        description={t('settings.providers.page.empty.checkOpenCodeConfiguration')}
      >
        {null}
      </SettingsPageLayout>
    );
  ...
  if (!selectedProvider) {
    return (
      <SettingsPageLayout
        title={t('settings.providers.page.empty.selectProviderFromSidebar')}
        description={t('settings.providers.page.empty.reviewDetailsAndConfigureAuth')}
      >
        {null}
      </SettingsPageLayout>
    );
