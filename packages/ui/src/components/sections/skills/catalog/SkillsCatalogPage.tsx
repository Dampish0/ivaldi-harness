...
const SourceCard: React.FC<{
  ...
  isMobile: boolean;
}> = ({ source, isActive, isLoading, skillsCount, onSelect, t, isMobile }) => {
  ...
  return (
    <button
      ...
      className={cn(
        'w-full text-left flex gap-3 items-start transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--interactive-focus-ring)]',
        isMobile
          ? 'min-h-0 rounded-md border-0 bg-transparent px-2 py-2.5 hover:bg-interactive-hover/50'
          : 'min-h-24 rounded-lg border bg-[var(--surface-elevated)] p-3.5',
  ...
  return (
    <>
      ...
      {showModeTabs && (
        ...
        <div data-settings-item="skills.catalog.search" className="mb-5">
          <div className="relative max-w-md">
            ...
            <Input
              ...
              className={cn('h-8 pl-8 w-full', isMobile && 'rounded-md', search && 'pr-8')}
            />
            {search && (
              <button
                type="button"
        ...
        >
          <div className={cn('grid grid-cols-1 sm:grid-cols-2', isMobile ? 'gap-0 py-1' : 'gap-3 py-1.5')}>
            {sources.map((src) => (
              <SourceCard
                key={src.id}
                source={src}
            ...
            <button
              ...
              className={cn(
                'text-left flex gap-3 items-start transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--interactive-focus-ring)]',
                isMobile
                  ? 'min-h-0 rounded-md border-0 bg-transparent px-2 py-2.5 hover:bg-interactive-hover/50'
                  : 'min-h-24 rounded-lg border border-dashed border-[var(--interactive-border)] hover:border-[var(--interactive-border-hover)] hover:bg-[var(--surface-muted)] p-3.5',
              )}
            >
              <span className={cn('flex items-center justify-center bg-transparent text-muted-foreground shrink-0', isMobile ? 'size-5' : 'rounded-md w-8 h-8')}>
        ...
        <SettingsSection>
          <div className="flex items-center justify-between gap-2 pb-2">
            <div className="flex items-center gap-2 min-w-0">
              <span className="typography-meta font-medium text-muted-foreground truncate">
                {listTitle}
              </span>
