...
export const AddCatalogDialog: React.FC<AddCatalogDialogProps> = ({ open, onOpenChange }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={cn('max-w-xl', isMobile && 'max-w-none gap-0 rounded-md p-0')}>
        ...
        <div className={cn('space-y-4', isMobile && 'px-4 py-4')}>
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={t('settings.skills.catalog.add.field.catalogNamePlaceholder')}
        ...
        <DialogFooter className={cn(isMobile && 'flex-row flex-wrap justify-end border-t border-border/40 px-4 py-3')}>
          <Button size={isMobile ? 'default' : 'sm'} variant="ghost" onClick={() => onOpenChange(false)}>
