  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running Ivaldi. Verify the address points to an Ivaldi server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The Ivaldi server at "${host || 'unknown'}" is not compatible with this app version. Update Ivaldi on the server, then try again.`,
