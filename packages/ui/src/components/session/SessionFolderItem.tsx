    ...
    <div className="oc-folder">
      ...
      <div
        ...
        className={cn(
          ...
          'cursor-pointer',
          isDropTarget && 'bg-interactive-selection ring-1 ring-inset ring-[var(--interactive-border)]',
        )}
      ...
      >
        <div className={cn(
          ...
          <Icon name={folderIconName} className={cn('h-3.5 w-3.5 flex-shrink-0', isDropTarget ? 'text-foreground' : 'text-muted-foreground')} />
            ...
            <div className="min-w-0 flex items-center gap-1.5 flex-1">
              <Tooltip>
                <TooltipTrigger asChild>
                  <span className={cn('typography-ui-label font-semibold truncate', isDropTarget ? 'text-foreground' : 'text-muted-foreground')}>
          ...
          >
            <div className="flex items-center gap-0.5">
              ...
              <button
                ...
                className="inline-flex h-6 w-6 items-center justify-center rounded-md text-muted-foreground hover:text-destructive hover:bg-interactive-hover/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--interactive-focus-ring)]"
