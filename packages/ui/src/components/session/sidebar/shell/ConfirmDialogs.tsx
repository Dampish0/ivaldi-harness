      ...
      <DialogContent showCloseButton={false} className="max-w-sm gap-5">
        ...
        <DialogFooter className="w-full sm:items-center sm:justify-between">
          <button
            ...
            className="inline-flex items-center gap-1.5 typography-ui-label text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--interactive-focus-ring)]"
            aria-pressed={!showDeletionDialog}
          >
            {!showDeletionDialog ? <Icon name="checkbox" className="h-4 w-4 text-foreground" /> : <Icon name="checkbox-blank" className="h-4 w-4" />}
