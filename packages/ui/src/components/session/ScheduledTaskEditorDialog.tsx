...
export function ScheduledTaskEditorDialog(props: {
  ...
  }, [isWorkMode, loadAgents, loadProviders, open]);
  ...
  const description = t(isWorkMode
    ? 'chat.work.scheduledTasks.editorDescription'
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              aria-label={t(isWorkMode
                ? 'chat.work.scheduledTasks.goalAria'
