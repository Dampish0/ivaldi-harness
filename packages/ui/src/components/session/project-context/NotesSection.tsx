  ...
  return (
    <div className="space-y-2">
      ...
      <Textarea
        ...
        scrollShadowSize={56}
        disabled={disabled}
        outerClassName="rounded-none border-b border-[var(--interactive-border)] bg-transparent ring-0 hover:[&:not(:focus-within)]:bg-transparent focus-within:ring-0"
        endSlot={(
          <>
      ...
      {/* The list itself stays unframed. Shared knowledge rows carry only the
          divider needed to separate entries. */}
      <div>
