  ...
  return (
    <span
      className={cn(
        ...
        // The readout wears its dot's status color, so the row reads as one
        // signal without borrowing the primary-action color.
        running ? 'text-[var(--status-success)]' : 'text-[var(--status-info)]',
        className,
      )}
