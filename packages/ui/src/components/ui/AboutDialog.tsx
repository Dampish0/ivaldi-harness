      ...
      <DialogContent className="max-w-xs p-6">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-1">
            <h2 className="text-lg font-semibold">Ivaldi</h2>
          ...
          <a
            href="https://github.com/Dampish0/ivaldi-harness"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 pt-2 typography-meta text-muted-foreground hover:text-foreground transition-colors"
          >
