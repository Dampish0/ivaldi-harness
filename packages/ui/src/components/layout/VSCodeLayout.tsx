...
export const VSCodeLayout: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    void vscodeApi.executeCommand('ivaldi.setActiveSession', currentSessionId, activeSessionTitle);
  ...
  React.useEffect(() => {
    ...
    void vscodeApi.executeCommand('ivaldi.updateSessionEditorTitle', currentSessionId, activeSessionTitle);
