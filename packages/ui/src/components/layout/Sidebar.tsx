...
const SIDEBAR_CONTENT_WIDTH = 240;
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, isMobile, children, className, topBar }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    'relative z-10 flex h-full shrink-0 flex-col transition-opacity duration-100 ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:transition-none motion-reduce:delay-0',
                    isResizing && 'pointer-events-none',
                    isOpen ? 'delay-[125ms]' : 'pointer-events-none select-none opacity-0 delay-0'
                )}
                style={{
