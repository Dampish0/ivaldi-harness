...
const ICON_BUTTON_CLASS =
  'app-region-no-drag inline-flex h-8 w-8 items-center justify-center gap-2 rounded-md typography-ui-label font-medium text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--interactive-focus-ring)] hover:bg-interactive-hover transition-colors';
  ...
  return (
    ...
    >
      <div ref={clusterRef} className="flex items-center gap-2">
        ...
        {isDeveloperMode && projectActionsContext ? (
