  ...
  const handleConfirmPlanSend = React.useCallback(
    async (execution: TodoSendExecution) => {
      ...
      try {
        ...
        if (isDeveloperMode && pendingPlanSend.target === 'worktree') {
    ...
    [canCreateWorktree, content, createSession, currentProjectRef, initializeNewOpenChamberSession, isDeveloperMode, pendingPlanSend, resolvedPath, routeToChat, sendMessage, sendPromptTitle, setCurrentSession]
  );
