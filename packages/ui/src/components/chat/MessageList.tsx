...
const TurnBlock = React.memo(({
    ...
    const userMessageHidden = React.useMemo(
        () => isHiddenUserMessage(turn.userMessage, { planModeEnabled, hideGoalProtocolMessages, hideCompactionProtocolMessages }),
        [planModeEnabled, hideGoalProtocolMessages, hideCompactionProtocolMessages, turn.userMessage]
    );
    ...
    const renderMessage = React.useCallback(
        (message: ChatMessageEntry) => {
            ...
            if (isUserMessage && userMessageHidden) return null;
