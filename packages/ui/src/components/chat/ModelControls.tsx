...
export const ModelControls: React.FC<ModelControlsProps> = ({
    ...
    const openProviderSettingsPage = React.useCallback(() => {
        if (mobileAppActions) {
            mobileAppActions.openSettings('providers');
        } else {
        ...
        closeMobilePanel();
    }, [closeMobilePanel, mobileAppActions, setAgentMenuOpen, setSettingsDialogOpen, setSettingsPage]);
    const openAddProviderSettings = React.useCallback(() => {
        setSelectedProvider(ADD_PROVIDER_ID);
        openProviderSettingsPage();
    }, [openProviderSettingsPage, setSelectedProvider]);
    const openWorkModelSettings = React.useCallback(() => {
        setSelectedProvider(currentProviderId || ADD_PROVIDER_ID);
        openProviderSettingsPage();
    }, [currentProviderId, openProviderSettingsPage, setSelectedProvider]);
                    ...
                    <div className="flex items-center gap-2 px-2 py-1.5">
                        <button
                            ...
                            className={cn(
                                ...
                                'rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--interactive-focus-ring)]'
                            )}
                        >
                        ...
                        <div className="flex flex-shrink-0 items-center gap-1.5">
                            <button
                                ...
                                className={cn(
                                    'model-favorite-button flex size-5 items-center justify-center hover:text-foreground flex-shrink-0',
                                    isFavoriteModel(providerId, modelId) ? 'text-foreground' : 'text-muted-foreground'
                                )}
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {inlineVariantOptions.map((variantOption) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                'inline-flex items-center rounded-md border px-2 py-1 typography-meta font-medium',
                                                isVariantSelected
                                                    ? 'border-border/60 bg-interactive-selection text-foreground'
                                                    : 'border-border/40 text-muted-foreground hover:bg-interactive-hover'
                                            )}
                                ...
                                {hasVariantOverflow ? (
                                    <button
                                        ...
                                        className="inline-flex items-center rounded-md border border-border/40 px-2 py-1 typography-meta font-medium text-muted-foreground hover:bg-interactive-hover"
            ...
            >
                <div className="flex flex-col gap-1">
                    <div>
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="h-9 rounded-md border-border/50 bg-[var(--surface-elevated)] pl-7 typography-meta"
                            />
                            {mobileModelQuery && (
                                <button
                                    type="button"
                    ...
                    {filteredFavorites.length > 0 && (
                        <section className="overflow-hidden border-b border-border/40 pb-1">
                            <div className="px-2 py-1.5 typography-meta font-medium text-muted-foreground">
                                <Icon name="star-fill" className="mr-1.5 inline-block size-3 text-muted-foreground" />
                    ...
                    {filteredProviders.map(({ provider, providerModels }) => {
                        ...
                        const isExpanded = expandedMobileProviders.has(provider.id) || normalizedQuery.length > 0;
                         ...
                         return (
                             <section key={provider.id} className="overflow-hidden border-b border-border/40 last:border-b-0">
                                <button
                                    type="button"
                                    onClick={() => {
                                    ...
                                    className="flex h-9 w-full items-center justify-between gap-1.5 rounded-md px-2 text-left hover:bg-interactive-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--interactive-focus-ring)]"
                                    aria-expanded={isExpanded}
                                >
                                    <div className="flex items-center gap-2">
                                        <ProviderLogo
                                        ...
                                        {isActiveProvider && (
                                            <span className="typography-micro text-muted-foreground">{t('chat.modelControls.current')}</span>
                                        )}
                                    </div>
                                    {isExpanded ? (
                ...
                renderHeader={mobileVariantTarget ? ((closeButton) => (
                    <div className="flex items-center justify-between px-3 py-2 border-b border-border/40">
                        <button
                            type="button"
                            onClick={handleBack}
                            className="flex items-center gap-1 rounded-md px-1.5 py-1 typography-meta text-muted-foreground hover:bg-interactive-hover"
                        >
                ...
                <div className="flex flex-col gap-0.5">
                    <button
                        ...
                        className={cn(
                            ...
                            isDefault ? 'bg-interactive-selection text-interactive-selection-foreground' : 'hover:bg-interactive-hover/50'
                        )}
                        onClick={() => handleSelect(undefined)}
                    >
                        <span className="typography-meta font-medium text-foreground">{t('chat.modelControls.default')}</span>
                        {isDefault && <Icon name="check" className="size-4 text-foreground flex-shrink-0" />}
                    </button>
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    'flex w-full items-center justify-between gap-2 rounded-md px-2.5 py-2 text-left',
                                    'focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--interactive-focus-ring)]',
                                    selected ? 'bg-interactive-selection text-interactive-selection-foreground' : 'hover:bg-interactive-hover/50'
                                )}
                                onClick={() => handleSelect(variant)}
                            >
                                <span className="typography-meta font-medium text-foreground">{label}</span>
                                {selected && <Icon name="check" className="size-4 text-foreground flex-shrink-0" />}
                            </button>
                        );
                    })}
                </div>
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    ...
                                    {isSelected && (
                                        <Icon name="check" className="ml-auto size-4 flex-shrink-0 text-interactive-selection-foreground" />
                                    )}
                                </div>
                                {agent.description && (
                                    <span className="typography-meta line-clamp-2 pl-4.5 text-muted-foreground">
                                        {agent.description}
                                    </span>
                                )}
                            </button>
    ...
    const renderModelSelector = () => {
        ...
        const handleModelPickerKeyDown = (e: React.KeyboardEvent, selectedItem: ModelPickerEntry | undefined) => {
            const cycleAgentDirection = isDeveloperMode ? getCycleAgentDirectionFromEvent(e) : null;
                        ...
                        <TooltipTrigger asChild>
                            <DropdownMenuTrigger asChild>
                                ...
                                >
                                    ...
                                    ) : isDeveloperMode && currentProviderId ? (
                                        <>
                                            <ProviderLogo
                            ...
                            <ModelPickerList
                                ...
                                emptyContent={!isDeveloperMode && desktopModelQuery.trim().length === 0 ? (
                                    <div className="flex flex-col items-center gap-2">
                                        <span>{t('chat.modelControls.noModelsFound')}</span>
                                ...
                                providerOrder={isDeveloperMode ? providerOrder : undefined}
                                onReorderProvider={isDeveloperMode ? setProviderOrder : undefined}
                                                    ...
                                                    <AgentDescriptionTooltip key={agent.name} description={agent.description}>
                                                        ...
                                                        >
                                                            <div className="flex min-w-0 flex-1 items-center gap-1.5">
                                                                ...
                                                                {isSelected ? (
                                                                    <Icon name="check" className="ml-auto size-3.5 flex-shrink-0 text-interactive-selection-foreground" />
                                                                ) : null}
                                                            </div>
                                                        </DropdownMenuItem>
    ...
    const renderWorkAgentChip = () => {
        if (
            isDeveloperMode
            || !isReady
            || !uiAgentName
            || !defaultAgentName
            || uiAgentName === defaultAgentName
        ) {
            return null;
        }
        ...
        return (
            <Button
                ...
                title={t('chat.modelControls.resetToDefault')}
                onClick={() => handleAgentChange(defaultAgentName)}
                className="max-w-[150px] rounded-full"
            >
                <Icon name="ai-agent" className="size-3.5" />
                <span className="truncate">{getAgentDisplayName()}</span>
        ...
        <>
            <div className={inlineClassName}>
                ...
                >
                    ...
                    {renderModelSelector()}
                    {isDeveloperMode ? renderAgentSelector() : renderWorkAgentChip()}
                </div>
            </div>
