    ...
    return createPortal(
      <div
        ...
        className={cn(
          ...
          'oc-glass-popover rounded-md border border-[var(--interactive-border)]',
          'p-1 shadow-none',
          'safe-area-bottom',
          'transition-[opacity,transform] duration-200 ease-out will-change-[opacity,transform]',
          isOpening ? 'opacity-0 translate-y-[4px]' : 'opacity-100 translate-y-0'
      ...
      >
        <div className="flex flex-col gap-0.5">
          <Button
            ...
            className="w-full justify-start gap-2 rounded-md px-3 text-left typography-ui-label"
            title={t('chat.textSelection.title.commentOnSelection')}
          >
            <Icon name="chat-1" className="size-4 flex-shrink-0 text-muted-foreground" />
          ...
          >
            <Icon name="add" className="size-4 flex-shrink-0 text-muted-foreground" />
          ...
          {!isVSCodeRuntime() ? (
            ...
            >
              {isAddingToNotes
                ? <Icon name="loader-4" className="size-4 flex-shrink-0 animate-spin text-muted-foreground" />
                : <Icon name="booklet" className="size-4 flex-shrink-0 text-muted-foreground" />}
