            ...
            {hasMultipleImages && (
                <>
                    <button
                        ...
                        className="absolute left-3 top-1/2 -translate-y-1/2 z-10 h-10 w-10 flex items-center justify-center rounded-full bg-black/40 text-foreground/90 hover:bg-black/55 focus:outline-none focus:ring-2 focus:ring-[var(--interactive-focus-ring)]"
                    ...
                    <button
                        ...
                        onMouseDown={(event) => event.stopPropagation()}
                        onClick={showNext}
                        className="absolute right-3 top-1/2 -translate-y-1/2 z-10 h-10 w-10 flex items-center justify-center rounded-full bg-black/40 text-foreground/90 hover:bg-black/55 focus:outline-none focus:ring-2 focus:ring-[var(--interactive-focus-ring)]"
            ...
            >
                ...
                >
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <button
                            type="button"
                            className="h-8 w-8 flex items-center justify-center rounded-lg text-muted-foreground/80 hover:text-foreground focus:outline-none focus:ring-2 focus:ring-[var(--interactive-focus-ring)]"
