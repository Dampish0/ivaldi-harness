...
type ComposerContentAttributeProps = Pick<
    ComposerEditorProps,
    'editable' | 'spellCheck' | 'autoCorrect' | 'autoCapitalize' | 'aria-label'
>;

const composerContentAttributes = (props: ComposerContentAttributeProps) => ({
    spellcheck: String(props.spellCheck ?? false),
...
export const ComposerEditor = React.forwardRef<ComposerEditorHandle, ComposerEditorProps>(
    function ComposerEditor(props, ref) {
                ...
                state: EditorState.create({
                    ...
                    extensions: [
                        ...
                        contentAttributesCompartment.of(
                            EditorView.contentAttributes.of(composerContentAttributes(handlersRef.current)),
                        ),
                    ] satisfies Extension[],
                }),
                parent: host,
        ...
        React.useEffect(() => {
            viewRef.current?.dispatch({
                effects: contentAttributesCompartment.reconfigure(
                    EditorView.contentAttributes.of(composerContentAttributes({
                        editable,
                        spellCheck,
                        autoCorrect,
                        autoCapitalize,
        ...
        }, [ariaLabel, autoCapitalize, autoCorrect, editable, spellCheck]);
