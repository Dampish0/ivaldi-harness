...
const TICK_BASE_WIDTH_PX = 12;
const TICK_ACTIVE_WIDTH_PX = 18;
const TICK_FOCUS_WIDTH_PX = 24;
...
// The panel itself supplies the container; rows stay flat and use only hover or
// selection fills so the navigator reads as one compact list.
                                ...
                                return (
                                    ...
                                    >
                                        <span
                                            aria-hidden="true"
                                            className={cn(
                                                'block h-[3px] rounded-[1px] transition-all duration-200 ease-out',
                                                isActive
                                                    ? 'bg-[var(--surface-foreground)]'
                                                    : isHighlighted
                                                        ? 'bg-[var(--surface-foreground)]/80'
                                                        : 'bg-[var(--surface-foreground)]/40',
                                            )}
