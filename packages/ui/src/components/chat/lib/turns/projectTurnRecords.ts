    ...
    messages.forEach((message, index) => {
        ...
        if (
            ...
            && isHiddenUserMessage(message, {
                ...
                hideGoalProtocolMessages: mergeHiddenUserTurns.hideGoalProtocolMessages,
                hideCompactionProtocolMessages: mergeHiddenUserTurns.hideCompactionProtocolMessages,
            })
        ) {
