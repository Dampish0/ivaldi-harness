...
export const selectMcpLoadErrorForDirectory = (
  state: Pick<McpConfigStore, 'loadErrorsByDirectory'>,
  directory?: string | null,
): string | null => {
  const cacheKey = getMcpCacheKey(resolveDirectory(directory));
            ...
            try {
              ...
              set((state) => ({
                ...
                loadErrorsByDirectory: {
                  ...
                  [cacheKey]: error instanceof Error ? error.message : 'Failed to load MCP configs',
                },
              }));
              return false;
            }
