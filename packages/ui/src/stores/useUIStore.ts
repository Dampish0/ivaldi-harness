...
interface UIStore {
  ...
  /** Optional desktop header shortcut showing the active Ivaldi instance. */
  showCurrentInstanceInHeader: boolean;
  ...
  setShowCurrentInstanceInHeader: (value: boolean) => void;
  ...
  devtools(
    persist(
      (set, get) => ({
        ...
        showCurrentInstanceInHeader: false,
        ...
        setShowCurrentInstanceInHeader: (value) => {
          set({ showCurrentInstanceInHeader: value });
        },
      ...
      }),
      {
        ...
        partialize: (state) => ({
          ...
          showCurrentInstanceInHeader: state.showCurrentInstanceInHeader,
