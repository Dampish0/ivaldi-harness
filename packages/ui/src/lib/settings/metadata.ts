...
export const SETTINGS_PAGE_METADATA: readonly SettingsPageMeta[] = [
  ...
  },
  {
    ...
    group: 'opencode',
    kind: 'single',
    keywords: ['lifecycle', 'hooks', 'automation', 'policy', 'preflight', 'prompt', 'command'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    slug: 'mcp',
  ...
  { slug: 'about', title: 'About', group: 'system', kind: 'single', keywords: ['about', 'version', 'updates', 'release', 'changelog'], isAvailable: (ctx) => !ctx.isVSCode },
  { slug: 'advanced', title: 'Advanced', group: 'system', kind: 'single', keywords: ['advanced', 'providers', 'agents', 'commands', 'mcp', 'plugins', 'skills', 'shortcuts'] },
  { slug: 'integrations', title: 'Integrations', group: 'projects', kind: 'single', keywords: ['integration', 'plugin', 'provider', 'oauth', 'claude', 'cursor', 'command code', 'connect', 'discord', 'telegram', 'messenger'] },
] as const;
