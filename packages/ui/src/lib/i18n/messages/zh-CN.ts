...
export const dict: Partial<Record<I18nKey, string>> = {
  ...
  ...permissionModeMessages['zh-CN'],
  ...sharedSettingsMessages['zh-CN'],
  ...
  "profile.setup.title": "怎么称呼你？",
  "profile.setup.description": "为你的 Ivaldi 个人资料选择一个名字。以后可以修改。",
  "profile.name.label": "你的名字",
  "profile.name.placeholder": "名字或用户名",
  "profile.actions.continue": "继续",
  "profile.actions.save": "保存",
  "profile.actions.edit": "编辑个人资料",
  "profile.fallback": "你的个人资料",
  "profile.error.invalid": "请输入 1 至 64 个字符的名字。",
  ...
  'mobile.connect.welcome.title': '连接到 Ivaldi',
  ...
  'mobile.connect.password.placeholder': 'Ivaldi 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 Ivaldi 服务器。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 Ivaldi',
  ...
  'sessions.sidebar.activity.projectsTitle': '项目',
  ...
  'header.sessionTabs.scrollLeftAria': '向左滚动标签页',
  'header.sessionTabs.scrollRightAria': '向右滚动标签页',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 Ivaldi 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 运行在 Ivaldi 所在的机器上，无法与其建立连接。这里不会显示你本机上的任何内容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它们运行在托管 Ivaldi 的那台机器上。要打开它们需要桌面应用。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Ivaldi 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 Ivaldi 中编辑。请下载后使用其他应用打开。',
  ...
  'filesView.tree.actions.moreAria': '更多文件操作',
  ...
  "directoryExplorerDialog.pathInput.label": "项目文件夹",
  "directoryExplorerDialog.work.description": "将相关聊天和文件集中到一个项目中。",
  "directoryExplorerDialog.work.existingFolder": "使用现有文件夹",
  "directoryExplorerDialog.work.newProject": "创建新项目",
  "directoryExplorerDialog.work.createProject": "创建项目",
  "directoryExplorerDialog.work.projectName": "项目名称",
  "directoryExplorerDialog.work.namePlaceholder": "例如：夏季活动",
  "directoryExplorerDialog.work.nameHint": "将使用此名称创建一个新文件夹。",
  "directoryExplorerDialog.work.nameExists": "同名文件夹已存在。请选择其他名称或使用现有文件夹。",
  "directoryExplorerDialog.work.invalidName": "请输入有效的文件夹名称，不包含斜杠或特殊字符。",
  "directoryExplorerDialog.work.saveLocation": "保存位置",
  "directoryExplorerDialog.work.chooseFolderHint": "选择包含项目文件的文件夹。",
  "directoryExplorerDialog.work.selectFolder": "使用此文件夹",
  "directoryExplorerDialog.actions.chooseFolder": "浏览文件夹...",
  "directoryExplorerDialog.actions.openingPicker": "正在打开...",
  "directoryExplorerDialog.title": "添加项目",
  "directoryExplorerDialog.description": "打开一个文件夹作为项目，或输入新路径来创建文件夹。",
  ...
  "directoryExplorerDialog.actions.addProject": "添加此文件夹",
  ...
  "directoryExplorerDialog.actions.createAndAdd": "创建并添加文件夹",
  "directoryExplorerDialog.actions.alreadyAdded": "文件夹已添加",
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Ivaldi 需要访问此文件夹。',
  ...
  "directoryExplorerDialog.footer.select": "打开文件夹",
  ...
  'aboutDialog.diagnosticsDescription': '包含 Ivaldi 状态、运行时健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Ivaldi',
  ...
  'header.actions.openAppMenu': 'Ivaldi 菜单',
  'header.actions.openAppMenuAria': '打开 Ivaldi 菜单',
  ...
  'chat.emptyState.opencodeUnreachable': '无法连接 Ivaldi 运行时',
  'chat.emptyState.startNewChat': '开始新的聊天',
  'chat.work.newChat': '新建聊天',
  'chat.work.startNewFromAnswer': '从此回答开始新聊天',
  'chat.work.keepWorkingUntilComplete': '持续工作直到完成',
  'chat.work.showMore': '显示更多',
  'chat.work.showFewer': '显示更少',
  'chat.work.searchChats': '搜索聊天',
  'chat.work.searchChatsPlaceholder': '搜索聊天...',
  'chat.work.selectChats': '选择聊天',
  'chat.work.noRecentChats': '没有最近的聊天',
  'chat.work.untitledChat': '未命名聊天',
  'chat.work.archive.searchPlaceholder': '搜索已归档聊天',
  'chat.work.archive.countSingle': '{count} 个已归档聊天',
  'chat.work.archive.countPlural': '{count} 个已归档聊天',
  'chat.work.archive.emptyNoArchived': '暂无已归档聊天',
  'chat.work.archive.emptyNoMatches': '没有匹配的已归档聊天',
  'chat.work.archive.deleteProject': '删除此项目中的所有已归档聊天',
  'chat.work.archive.deleteProjectAria': '删除 {label} 中的所有已归档聊天',
  'chat.work.scheduledTasks.description': '按计划启动新聊天并发送已配置提示词的任务。',
  'chat.work.scheduledTasks.editorDescription': '选择此任务何时启动新聊天并发送提示词。',
  'chat.work.scheduledTasks.goalAria': '将此任务作为目标运行直到完成',
  'chat.work.mobile.noProjectsDescription': '添加项目以使用其中的文件和上下文开展工作。',
  'chat.work.mobile.renameError': '重命名聊天失败',
  'chat.work.mobile.editOrderHint': '拖动手柄重新排序项目。完成后点击勾选。',
  'chat.emptyState.draftTitle': 'What are we working on?',
  'chat.emptyState.draftTitleWithProject': 'What are we working on in {project}?',
  'chat.emptyState.workDraftTitle': '我能帮你做什么？',
  'chat.emptyState.workDraftTitleWithProject': '在 {project} 中我能帮你做什么？',
  'chat.emptyState.workDraftSubtitle': '需要时，我可以使用你的文件、网页、集成、MCP 工具、插件和技能。',
  ...
  'chat.draftPresets.researchTopic.label': '调研主题',
  'chat.draftPresets.draftDocument.label': '起草文档',
  'chat.draftPresets.analyzeFiles.label': '分析文件',
  'chat.draftPresets.projectPlan.label': '规划项目',
  'chat.draftPresets.summarizeProject.label': '总结项目',
  ...
  'chat.work.draftStarters.add': '添加建议',
  'chat.work.draftStarters.searchPlaceholder': '搜索操作和技能…',
  'chat.work.draftStarters.empty': '没有其他可添加的内容',
  'chat.work.draftStarters.sectionBuiltIn': '推荐操作',
  'chat.work.draftStarters.sectionCommands': '操作',
  'chat.work.draftStarters.sectionSkills': '技能',
  'chat.work.draftStarters.remove': '移除建议',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'Ivaldi 运行时在回复仍在生成时重启了。发送一条消息以继续。',
  ...
  'chat.chatInput.commandChip.planLabel': '计划',
  'chat.chatInput.commandChip.goalLabel': '目标',
  ...
  'chat.activity.label': '活动',
  'chat.activity.more': '另有 {count} 项...',
  ...
  'chat.permissionCard.replaceAllOccurrences': '替换所有匹配项',
  ...
  'openCodeStatusDialog.title': 'Ivaldi 运行时状态',
  'openCodeStatusDialog.description': '查看当前 Ivaldi 运行时状态与诊断信息。',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 Ivaldi，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Ivaldi',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Ivaldi 服务器之间切换',
  ...
  'multiRun.window.description': 'Ivaldi 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Ivaldi',
  ...
  'onboarding.localSetup.title': '设置 Ivaldi',
  'onboarding.localSetup.description': 'Ivaldi 需要 OpenCode CLI 运行时才能继续。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Ivaldi 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': '安装 Ivaldi 用于本地智能体会话的运行时。',
  ...
  'onboarding.localSetup.status.watching': '正在等待 Ivaldi 运行时',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Ivaldi 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Ivaldi 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Ivaldi 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Ivaldi。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Ivaldi，但与此应用版本不兼容。请更新服务器上的 Ivaldi 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Ivaldi。请确认地址是否指向 Ivaldi 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 Ivaldi 运行时不可用',
  'onboarding.desktopRecovery.localUnavailable.description': '本地智能体运行时无法启动或未安装。请安装 OpenCode CLI 运行时，或改为连接远程 Ivaldi 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Ivaldi。请确认地址是否指向 Ivaldi 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Ivaldi 服务器与此应用版本不兼容。请更新服务器上的 Ivaldi 后重试。',
  ...
  'startup.initRecovery.description': 'Ivaldi 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 Ivaldi 打开。',
  ...
  'openChamberLogo.aria.logo': 'Ivaldi 标志',
