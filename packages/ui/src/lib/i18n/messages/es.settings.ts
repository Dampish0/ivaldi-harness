...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copia el ID desde la URL del panel y la cookie auth desde las herramientas del navegador. Ivaldi nunca examina las cookies del navegador.',
  ...
  "settings.window.description": "Ventana de configuración de Ivaldi.",
  ...
  "settings.view.nav.group.opencode": "IA y agentes",
  "settings.view.nav.group.advanced": "Avanzado",
  "settings.view.nav.group.tools": "Herramientas",
  ...
  "settings.page.appearance.description": "Personaliza el aspecto y la sensación de Ivaldi.",
  "settings.page.chat.title": "Chat",
  "settings.page.chat.description": "Configura cómo se muestran los mensajes y las herramientas.",
  "settings.page.work.chat.description": "Configura la apariencia del chat, el razonamiento, los borradores y la retención.",
  "settings.page.work.chat.retention.title": "Retención de chats",
  "settings.page.work.chat.retention.tooltip": "Archiva o elimina automáticamente los chats inactivos según la última actividad. Conserva los 5 chats más recientes.",
  "settings.page.work.chat.retention.whenChatsExpire": "Cuando caduquen los chats",
  "settings.page.work.chat.retention.toast.noneEligibleArchive": "No hay chats disponibles para archivar",
  "settings.page.work.chat.retention.toast.noneEligibleDelete": "No hay chats disponibles para eliminar",
  "settings.page.work.chat.retention.toast.archivedCount": "Se archivaron {count} chat(s)",
  "settings.page.work.chat.retention.toast.deletedCount": "Se eliminaron {count} chat(s)",
  "settings.page.work.chat.retention.toast.failedArchiveCount": "No se pudieron archivar {count} chat(s)",
  "settings.page.work.chat.retention.toast.failedDeleteCount": "No se pudieron eliminar {count} chat(s)",
  ...
  "settings.page.work.ai.description": "Elige el modelo, el nivel de razonamiento y el asistente para los chats nuevos.",
  "settings.page.work.ai.defaultsTitle": "Valores predeterminados para chats nuevos",
  ...
  "settings.remoteInstances.direct.title": "Otros servidores de Ivaldi",
  "settings.remoteInstances.headerSwitcher.label": "Mostrar la instancia actual en el encabezado",
  "settings.remoteInstances.headerSwitcher.info": "Muestra la instancia activa de Ivaldi en el encabezado de la aplicación y permite cambiar de instancia desde allí.",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Añade otro servidor de Ivaldi por URL. Úsalo cuando el servidor ya esté en marcha y tengas un token de conexión.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crea un enlace o token seguro para que Ivaldi Desktop pueda conectarse a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrScanHint": "Escanéalo con la app de Ivaldi en tu otro dispositivo. Es de un solo uso y caduca.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona en casa y fuera. Fuera de casa el tráfico pasa por Ivaldi Private Relay, un túnel cifrado de extremo a extremo. Sin configuración.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escanea este código QR con la app de Ivaldi en tu otro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Elige si Ivaldi debe iniciar el servidor por ti o conectarse a uno que ya está en marcha.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Puerto que Ivaldi usa en la máquina remota. Déjalo vacío para elegir uno automáticamente.",
  ...
  "settings.common.state.loadFailed": "No se pudo cargar esta sección. Se muestran los últimos datos cargados cuando están disponibles.",
  ...
  "settings.openchamber.about.title": "Acerca de Ivaldi",
  ...
  "settings.page.behavior.title": "Comportamiento del agente",
  ...
  "settings.gitIdentities.page.state.loadFailed": "No se pudieron cargar las identidades de Git. Vuelve a intentarlo para actualizar esta sección.",
  ...
  "settings.skills.sidebar.state.loadFailed": "No se pudieron cargar las habilidades.",
  "settings.skills.page.state.loadFailed": "No se pudo cargar esta habilidad.",
  "settings.skills.page.state.refreshFailed": "No se pudo actualizar esta habilidad. Se muestra la última versión cargada.",
  "settings.skills.page.actions.retry": "Reintentar",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Añade un repositorio Git como nuevo origen de catálogo. Ivaldi escaneará para encontrar carpetas que contengan",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar Ivaldi al iniciar sesión",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar Ivaldi al iniciar sesión",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar Ivaldi en la barra de menús de macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar Ivaldi en la barra de menús",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Requiere reiniciar la aplicación. Al desactivarlo, Ivaldi no crea el elemento de la barra de menús ni ejecuta sus actualizaciones de sesiones, aprobaciones y uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Cerrar Ivaldi a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Cerrar a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantiene Ivaldi en ejecución en la bandeja del sistema cuando se cierra la ventana principal. Al minimizar, la ventana sigue en la barra de tareas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Mantener el ordenador activo mientras Ivaldi está en ejecución",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Mantener el ordenador activo mientras Ivaldi está en ejecución",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "Ivaldi la pide después del reinicio y luego cuando vence la sesión: tras 12 horas, o 7 días con Confiar en este dispositivo. Déjalo vacío para desactivar el inicio de sesión.",
  ...
  "settings.openchamber.tools.title": "Herramientas de Ivaldi",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Herramienta Ivaldi Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Activar la herramienta Ivaldi Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permite que los agentes vean la página en el panel de navegador de Ivaldi e interactúen con ella: abrir una URL, leer el contenido, hacer clic, escribir, desplazarse y alternar entre diseño móvil y de escritorio. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras reiniciar OpenCode.",
  ...
  "settings.openchamber.keyboardShortcuts.action.reopen_session_tab.label": "Reabrir pestaña de sesión cerrada",
  ...
  "settings.remoteInstances.page.description": "Conéctate a otra máquina por SSH y abre Ivaldi allí.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Ivaldi en la máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Elige cómo debe ejecutarse Ivaldi después de conectar por SSH.",
  "settings.remoteInstances.page.section.mainTunnel": "Acceso desde este equipo",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Ivaldi se ejecuta en la máquina remota. Estos ajustes solo controlan la dirección de este equipo que lleva hasta ella por el túnel SSH.",
  "settings.remoteInstances.page.section.authentication": "Autenticación",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciales opcionales para SSH y la interfaz de usuario de Ivaldi remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Cómo debe colocarse Ivaldi en la máquina remota cuando esta app lo inicia por ti.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Primero indica un puerto remoto. En el modo «Ya está en ejecución», Ivaldi necesita saber en qué puerto escucha el servidor.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Permitir también que otros dispositivos de la red de la máquina remota abran este Ivaldi directamente, sin el túnel SSH. Requiere contraseña de la interfaz.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Cualquiera en esa red puede llegar al Ivaldi remoto. Solo lo protege la contraseña de la interfaz de abajo.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Define primero una contraseña de la interfaz. Sin ella, el Ivaldi remoto quedaría abierto a todos los dispositivos de esa red.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Contraseña con la que se protegerá la interfaz remota de Ivaldi. Ivaldi la aplica al servidor que inicia por ti.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Contraseña del servidor Ivaldi que ya se ejecuta en la máquina remota, usada para iniciar sesión.",
  ...
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Actualizando Ivaldi",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Se guarda en la autenticación de OpenCode, no en Ivaldi. Usa {env:VAR_NAME} para leer una clave del entorno.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Las claves se envían directamente a OpenCode y nunca se almacenan en Ivaldi.",
  ...
  "settings.openchamber.defaults.field.provider": "Proveedor",
  ...
  "settings.openchamber.defaults.field.defaultAssistant": "Asistente predeterminado",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponible como respaldo si se elimina la autenticación de Ivaldi",
  ...
  "settings.notifications.page.testNotification.body": "Esta es una notificación de prueba de Ivaldi.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcripción local en el servidor de Ivaldi. Los modelos se descargan automáticamente; no se necesita clave de API.",
  "settings.voice.page.tooltip.localTts": "Síntesis local en el servidor de Ivaldi (Kokoro, inglés). El modelo se descarga automáticamente; no se necesita clave de API.",
