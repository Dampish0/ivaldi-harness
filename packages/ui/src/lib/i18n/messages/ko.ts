...
export const dict: Partial<Record<I18nKey, string>> = {
  ...
  ...permissionModeMessages.ko,
  ...sharedSettingsMessages.ko,
  ...
  "profile.setup.title": "어떻게 불러 드릴까요?",
  "profile.setup.description": "Ivaldi 프로필 이름을 정하세요. 나중에 변경할 수 있습니다.",
  "profile.name.label": "이름",
  "profile.name.placeholder": "이름 또는 사용자 이름",
  "profile.actions.continue": "계속",
  "profile.actions.save": "저장",
  "profile.actions.edit": "프로필 수정",
  "profile.fallback": "내 프로필",
  "profile.error.invalid": "1~64자의 이름을 입력하세요.",
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Ivaldi를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Ivaldi가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'Ivaldi에 연결',
  ...
  'mobile.connect.password.placeholder': 'Ivaldi 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 Ivaldi 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'Ivaldi Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 Ivaldi 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'Ivaldi 정보',
  ...
  'sessions.sidebar.activity.projectsTitle': '프로젝트',
  ...
  'header.sessionTabs.scrollLeftAria': '탭을 왼쪽으로 스크롤',
  'header.sessionTabs.scrollRightAria': '탭을 오른쪽으로 스크롤',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 Ivaldi 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 은(는) Ivaldi가 실행 중인 컴퓨터에 있으며, 그곳으로의 연결을 열지 못했습니다. 이 화면에는 사용자 컴퓨터의 내용이 표시되지 않습니다.',
  ...
  'contextPanel.browser.devServers.remoteOnly': '이 서버들은 Ivaldi가 실행 중인 컴퓨터에 있습니다. 열려면 데스크톱 앱이 필요합니다.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Ivaldi에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 Ivaldi에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'filesView.tree.actions.moreAria': '추가 파일 작업',
  ...
  "directoryExplorerDialog.pathInput.label": "프로젝트 폴더",
  "directoryExplorerDialog.work.description": "관련 채팅과 파일을 프로젝트에 모아 관리하세요.",
  "directoryExplorerDialog.work.existingFolder": "기존 폴더 사용",
  "directoryExplorerDialog.work.newProject": "새 프로젝트 만들기",
  "directoryExplorerDialog.work.createProject": "프로젝트 만들기",
  "directoryExplorerDialog.work.projectName": "프로젝트 이름",
  "directoryExplorerDialog.work.namePlaceholder": "예: 여름 캠페인",
  "directoryExplorerDialog.work.nameHint": "이 이름으로 새 폴더가 만들어집니다.",
  "directoryExplorerDialog.work.nameExists": "같은 이름의 폴더가 이미 있습니다. 다른 이름을 선택하거나 기존 폴더를 사용하세요.",
  "directoryExplorerDialog.work.invalidName": "슬래시나 특수 문자가 없는 유효한 폴더 이름을 입력하세요.",
  "directoryExplorerDialog.work.saveLocation": "저장 위치",
  "directoryExplorerDialog.work.chooseFolderHint": "프로젝트 파일이 들어 있는 폴더를 선택하세요.",
  "directoryExplorerDialog.work.selectFolder": "이 폴더 사용",
  "directoryExplorerDialog.actions.chooseFolder": "폴더 찾아보기...",
  "directoryExplorerDialog.actions.openingPicker": "여는 중...",
  "directoryExplorerDialog.title": "프로젝트 추가",
  "directoryExplorerDialog.description": "프로젝트로 사용할 폴더를 열거나 새 폴더 경로를 입력해 만드세요.",
  ...
  "directoryExplorerDialog.actions.addProject": "이 폴더 추가",
  ...
  "directoryExplorerDialog.actions.createAndAdd": "폴더 만들고 추가",
  "directoryExplorerDialog.actions.alreadyAdded": "이미 추가된 폴더",
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Ivaldi에서 이 폴더에 접근해야 합니다.',
  ...
  "directoryExplorerDialog.footer.select": "폴더 열기",
  ...
  'aboutDialog.openChamberVersionLabel': 'Ivaldi 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Ivaldi 상태, 런타임 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 Ivaldi를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Ivaldi 메뉴',
  'header.actions.openAppMenuAria': 'Ivaldi 메뉴 열기',
  ...
  'chat.emptyState.opencodeUnreachable': 'Ivaldi 런타임에 연결할 수 없음',
  'chat.emptyState.startNewChat': '새 채팅 시작',
  'chat.work.newChat': '새 채팅',
  'chat.work.startNewFromAnswer': '이 답변에서 새 채팅 시작',
  'chat.work.keepWorkingUntilComplete': '완료할 때까지 계속 작업',
  'chat.work.showMore': '더 보기',
  'chat.work.showFewer': '간략히 보기',
  'chat.work.searchChats': '채팅 검색',
  'chat.work.searchChatsPlaceholder': '채팅 검색...',
  'chat.work.selectChats': '채팅 선택',
  'chat.work.noRecentChats': '최근 채팅 없음',
  'chat.work.untitledChat': '제목 없는 채팅',
  'chat.work.archive.searchPlaceholder': '보관된 채팅 검색',
  'chat.work.archive.countSingle': '보관된 채팅 {count}개',
  'chat.work.archive.countPlural': '보관된 채팅 {count}개',
  'chat.work.archive.emptyNoArchived': '보관된 채팅 없음',
  'chat.work.archive.emptyNoMatches': '일치하는 보관된 채팅 없음',
  'chat.work.archive.deleteProject': '이 프로젝트의 보관된 채팅 모두 삭제',
  'chat.work.archive.deleteProjectAria': '{label}의 보관된 채팅 모두 삭제',
  'chat.work.scheduledTasks.description': '일정에 따라 새 채팅을 시작하고 설정된 프롬프트를 보내는 작업입니다.',
  'chat.work.scheduledTasks.editorDescription': '이 작업이 새 채팅을 시작하고 프롬프트를 보낼 시간을 선택하세요.',
  'chat.work.scheduledTasks.goalAria': '이 작업을 완료될 때까지 목표로 실행',
  'chat.work.mobile.noProjectsDescription': '프로젝트를 추가해 파일과 컨텍스트로 작업하세요.',
  'chat.work.mobile.renameError': '채팅 이름을 바꾸지 못했습니다',
  'chat.work.mobile.editOrderHint': '핸들을 드래그해 프로젝트 순서를 바꾸세요. 완료하려면 체크를 탭하세요.',
  'chat.emptyState.draftTitle': 'What are we working on?',
  'chat.emptyState.draftTitleWithProject': 'What are we working on in {project}?',
  'chat.emptyState.workDraftTitle': '무엇을 도와드릴까요?',
  'chat.emptyState.workDraftTitleWithProject': '{project}에서 무엇을 도와드릴까요?',
  'chat.emptyState.workDraftSubtitle': '필요할 때 파일, 웹, 연동 서비스, MCP 도구, 플러그인, 스킬을 사용할 수 있습니다.',
  ...
  'chat.draftPresets.researchTopic.label': '주제 조사',
  'chat.draftPresets.draftDocument.label': '문서 작성',
  'chat.draftPresets.analyzeFiles.label': '파일 분석',
  'chat.draftPresets.projectPlan.label': '프로젝트 계획',
  'chat.draftPresets.summarizeProject.label': '프로젝트 요약',
  ...
  'chat.work.draftStarters.add': '제안 추가',
  'chat.work.draftStarters.searchPlaceholder': '작업 및 스킬 검색…',
  'chat.work.draftStarters.empty': '더 추가할 항목이 없습니다',
  'chat.work.draftStarters.sectionBuiltIn': '추천 작업',
  'chat.work.draftStarters.sectionCommands': '작업',
  'chat.work.draftStarters.sectionSkills': '스킬',
  'chat.work.draftStarters.remove': '제안 제거',
  ...
  'chat.toast.opencodeRestartInterrupted.description': '응답이 진행 중인 동안 Ivaldi 런타임이 다시 시작되었습니다. 계속하려면 메시지를 보내세요.',
  ...
  'chat.chatInput.commandChip.removeAria': '{command} 제거',
  'chat.chatInput.commandChip.planLabel': '계획',
  'chat.chatInput.commandChip.goalLabel': '목표',
  ...
  'chat.activity.label': '활동',
  'chat.activity.more': '+{count}개 더...',
  ...
  'chat.permissionCard.replaceAllOccurrences': '모든 일치 항목 바꾸기',
  ...
  'openCodeStatusDialog.title': 'Ivaldi 런타임 상태',
  'openCodeStatusDialog.description': '현재 Ivaldi 런타임 상태와 진단 정보를 확인합니다.',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 Ivaldi를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'Ivaldi 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Ivaldi 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Ivaldi 멀티런 창.',
  ...
  'onboarding.chooser.title': 'Ivaldi에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'Ivaldi 설정',
  'onboarding.localSetup.description': '계속하려면 Ivaldi가 사용하는 OpenCode CLI 런타임이 필요합니다.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Ivaldi가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'Ivaldi가 로컬 에이전트 세션에 사용하는 런타임을 설치하세요.',
  ...
  'onboarding.localSetup.status.watching': 'Ivaldi 런타임 대기 중',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Ivaldi 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 Ivaldi 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Ivaldi 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Ivaldi 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Ivaldi가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Ivaldi를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Ivaldi가 실행 중이 아닙니다. 주소가 Ivaldi 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 Ivaldi 런타임을 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': '로컬 에이전트 런타임을 시작할 수 없거나 설치되어 있지 않습니다. OpenCode CLI 런타임을 설치하거나 원격 Ivaldi 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 Ivaldi가 실행 중이 아닙니다. 주소가 Ivaldi 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 Ivaldi 서버가 이 앱 버전과 호환되지 않습니다. 서버의 Ivaldi를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'Ivaldi 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Ivaldi 업데이트 중…',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Ivaldi를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'Ivaldi 로고',
