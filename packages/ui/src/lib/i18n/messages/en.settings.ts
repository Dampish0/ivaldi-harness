...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. Ivaldi never scans browser cookie storage.',
  ...
  'settings.window.description': 'Ivaldi settings window.',
  ...
  'settings.view.nav.group.opencode': 'AI & Agents',
  'settings.view.nav.group.advanced': 'Advanced',
  'settings.view.nav.group.tools': 'Tools',
  ...
  'settings.page.appearance.description': 'Customize how Ivaldi looks and feels.',
  'settings.page.chat.title': 'Chat',
  'settings.page.chat.description': 'Configure how messages and tools are displayed.',
  'settings.page.work.chat.description': 'Configure chat appearance, reasoning, drafts, and retention.',
  'settings.page.work.chat.retention.title': 'Chat retention',
  'settings.page.work.chat.retention.tooltip': 'Automatically archive or delete inactive chats based on last activity. Keeps the 5 most recent chats.',
  'settings.page.work.chat.retention.whenChatsExpire': 'When chats expire',
  'settings.page.work.chat.retention.toast.noneEligibleArchive': 'No chats eligible for archiving',
  'settings.page.work.chat.retention.toast.noneEligibleDelete': 'No chats eligible for deletion',
  'settings.page.work.chat.retention.toast.archivedCount': 'Archived {count} chat(s)',
  'settings.page.work.chat.retention.toast.deletedCount': 'Deleted {count} chat(s)',
  'settings.page.work.chat.retention.toast.failedArchiveCount': 'Failed to archive {count} chat(s)',
  'settings.page.work.chat.retention.toast.failedDeleteCount': 'Failed to delete {count} chat(s)',
  ...
  'settings.page.work.ai.description': 'Choose the model, thinking level, and assistant used for new chats.',
  'settings.page.work.ai.defaultsTitle': 'New chat defaults',
  ...
  'settings.remoteInstances.direct.title': 'Other Ivaldi servers',
  'settings.remoteInstances.headerSwitcher.label': 'Show current instance in header',
  'settings.remoteInstances.headerSwitcher.info': 'Shows the active Ivaldi instance in the app header and lets you switch instances from there.',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another Ivaldi server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Ivaldi Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the Ivaldi app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through Ivaldi Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the Ivaldi app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Ivaldi should start the server for you, or connect to one that is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port Ivaldi uses on the remote machine. Leave empty to choose one automatically.',
  ...
  'settings.common.state.loadFailed': 'Could not load this section. Showing the last loaded data when available.',
  ...
  'settings.openchamber.about.title': 'About Ivaldi',
  ...
  'settings.page.behavior.title': 'Agent Behavior',
  ...
  'settings.gitIdentities.page.state.loadFailed': 'Could not load Git identities. Retry to refresh this section.',
  ...
  'settings.skills.sidebar.state.loadFailed': 'Could not load skills.',
  'settings.skills.page.state.loadFailed': 'Could not load this skill.',
  'settings.skills.page.state.refreshFailed': 'Could not refresh this skill. Showing the last loaded version.',
  'settings.skills.page.actions.retry': 'Retry',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Ivaldi will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start Ivaldi at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start Ivaldi when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show Ivaldi in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show Ivaldi in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, Ivaldi does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Close Ivaldi to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps Ivaldi running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Ivaldi is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while Ivaldi is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Ivaldi asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.tools.title': 'Ivaldi Tools',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Ivaldi Web tool',
  'settings.openchamber.tools.field.agentWebToolAria': 'Enable the Ivaldi Web tool',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in Ivaldi\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  ...
  'settings.openchamber.keyboardShortcuts.action.reopen_session_tab.label': "Reopen closed session tab",
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Ivaldi there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Ivaldi on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Ivaldi should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Access from this computer',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Ivaldi runs on the remote machine. These settings only control the address on this computer that forwards to it through the SSH tunnel.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Ivaldi UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Ivaldi should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Set a remote port first. In "Already running" mode Ivaldi needs to know which port the server listens on.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Also let other devices on the remote machine’s network open this Ivaldi server directly, without the SSH tunnel. A UI password is required.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Anyone on that network can reach the remote Ivaldi server. It is protected only by the UI password below.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Set a UI password first. Publishing the remote Ivaldi server to its network without one would leave it open to every device there.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Password to protect the remote Ivaldi UI. Ivaldi sets it on the server it starts for you.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Password of the Ivaldi server already running on the remote machine, used to sign in to it.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing Ivaldi',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating Ivaldi',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by Ivaldi. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Ivaldi.',
  ...
  'settings.openchamber.defaults.field.provider': 'Provider',
  ...
  'settings.openchamber.defaults.field.defaultAssistant': 'Default assistant',
  ...
  'settings.github.page.flow.title': 'Authorize Ivaldi',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Ivaldi auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Ivaldi.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the Ivaldi server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the Ivaldi server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  ...lifecycleHooksI18n.en,
} as const;

export type SettingsI18nKey = keyof typeof settingsDict;
