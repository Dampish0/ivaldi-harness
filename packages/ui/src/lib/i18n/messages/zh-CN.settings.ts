...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '从控制面板网址复制工作区 ID，并从浏览器开发者工具复制 auth Cookie。Ivaldi 绝不会扫描浏览器 Cookie 存储。',
  ...
  'settings.window.description': 'Ivaldi 设置窗口。',
  ...
  'settings.view.nav.group.opencode': 'AI 与智能体',
  'settings.view.nav.group.advanced': '高级',
  'settings.view.nav.group.tools': '工具',
  'settings.view.nav.group.content': '提示词',
  'settings.view.nav.group.system': '系统',
  'settings.page.projects.title': '项目',
  'settings.page.remoteInstances.title': '远程实例',
  'settings.page.providers.title': '模型与提供商',
  ...
  'settings.page.appearance.description': '自定义 Ivaldi 的外观与体验。',
  'settings.page.chat.title': '聊天',
  'settings.page.chat.description': '配置消息和工具的显示方式。',
  'settings.page.work.chat.description': '配置聊天外观、推理、草稿和保留设置。',
  'settings.page.work.chat.retention.title': '聊天保留',
  'settings.page.work.chat.retention.tooltip': '根据最后活动时间自动归档或删除不活跃的聊天，并保留最近的 5 个聊天。',
  'settings.page.work.chat.retention.whenChatsExpire': '聊天到期时',
  'settings.page.work.chat.retention.toast.noneEligibleArchive': '没有可归档的聊天',
  'settings.page.work.chat.retention.toast.noneEligibleDelete': '没有可删除的聊天',
  'settings.page.work.chat.retention.toast.archivedCount': '已归档 {count} 个聊天',
  'settings.page.work.chat.retention.toast.deletedCount': '已删除 {count} 个聊天',
  'settings.page.work.chat.retention.toast.failedArchiveCount': '{count} 个聊天归档失败',
  'settings.page.work.chat.retention.toast.failedDeleteCount': '{count} 个聊天删除失败',
  ...
  'settings.page.work.ai.description': '选择新聊天使用的模型、思考级别和助手。',
  'settings.page.work.ai.defaultsTitle': '新聊天默认设置',
  ...
  'settings.remoteInstances.direct.title': '其他 Ivaldi 服务器',
  'settings.remoteInstances.headerSwitcher.label': '在标题栏中显示当前实例',
  'settings.remoteInstances.headerSwitcher.info': '在应用标题栏中显示当前 Ivaldi 实例，并可从那里切换实例。',
  'settings.remoteInstances.direct.description': '此应用可切换到的服务器。从另一台服务器导入配对链接，或通过地址添加。',
  'settings.remoteInstances.direct.addDialog.description': '通过 URL 添加另一个 Ivaldi 服务器。适用于服务器已在运行且你拥有连接令牌的情况。',
  ...
  'settings.remoteInstances.clientAuth.description': '创建安全链接或令牌，让 Ivaldi Desktop 可以连接到此服务器。',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '用另一台设备上的 Ivaldi 应用扫描。一次性使用且会过期。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '在家和外出都可用。外出时流量经由 Ivaldi Private Relay(端到端加密隧道)传输，无需配置。',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '用其他设备上的 Ivaldi 应用扫描此二维码。',
  ...
  'settings.remoteInstances.page.field.modeHint': '选择是由 Ivaldi 为你启动服务器，还是连接到已在运行的服务器。',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Ivaldi 在远程机器上使用的端口。留空则自动选择。',
  ...
  'settings.common.state.loadFailed': '无法加载此部分。若有可用数据，将显示上次加载的内容。',
  ...
  'settings.openchamber.about.title': '关于 Ivaldi',
  ...
  'settings.page.behavior.title': '智能体行为',
  ...
  'settings.gitIdentities.page.state.loadFailed': '无法加载 Git 身份。请重试以刷新此部分。',
  ...
  'settings.skills.sidebar.state.loadFailed': '无法加载技能。',
  'settings.skills.page.state.loadFailed': '无法加载此技能。',
  'settings.skills.page.state.refreshFailed': '无法刷新此技能。正在显示上次加载的版本。',
  'settings.skills.page.actions.retry': '重试',
  ...
  'settings.skills.catalog.add.descriptionPrefix': '将 Git 仓库添加为新的目录来源。Ivaldi 会扫描其中包含',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 Ivaldi',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 Ivaldi',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': '在 macOS 菜单栏中显示 Ivaldi',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '在菜单栏中显示 Ivaldi',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '需要重启应用。关闭后，Ivaldi 不会创建菜单栏项目，也不会运行相关的会话、审批和用量更新。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 Ivaldi 关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '关闭主窗口时，让 Ivaldi 继续在系统托盘中运行；最小化仍会将窗口保留在任务栏。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Ivaldi 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Ivaldi 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Ivaldi 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.openchamber.tools.title': 'Ivaldi 工具',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Ivaldi Web 工具',
  'settings.openchamber.tools.field.agentWebToolAria': '启用 Ivaldi Web 工具',
  'settings.openchamber.tools.field.agentWebToolInfo': '让智能体在 Ivaldi 浏览器面板中查看并操作页面：打开网址、读取内容、点击、输入、滚动，以及在移动端与桌面端布局之间切换。会为每个会话添加少量工具说明。在 OpenCode 重启后生效。',
  ...
  'settings.openchamber.keyboardShortcuts.action.reopen_session_tab.label': "重新打开已关闭的会话标签页",
  ...
  'settings.remoteInstances.page.description': '通过 SSH 连接到另一台机器，并在那里打开 Ivaldi。',
  ...
  'settings.remoteInstances.page.section.remoteServer': '远程机器上的 Ivaldi',
  'settings.remoteInstances.page.section.remoteServerDescription': '选择 SSH 连接后 Ivaldi 的运行方式。',
  'settings.remoteInstances.page.section.mainTunnel': '从这台电脑访问',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Ivaldi 运行在远程机器上。这里的设置只决定这台电脑上通过 SSH 隧道通向它的地址。',
  'settings.remoteInstances.page.section.authentication': '认证',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH 和远程 Ivaldi UI 的可选凭据。',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '当此应用为你启动 Ivaldi 时，如何将它放到远程机器上。',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': '请先指定远程端口。在“已在运行”模式下，Ivaldi 需要知道服务器监听哪个端口。',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': '也允许远程机器所在网络中的其他设备不经 SSH 隧道直接打开这个 Ivaldi。必须设置界面密码。',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': '该网络中的任何人都能访问远程 Ivaldi，保护它的只有下面的界面密码。',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': '请先设置界面密码。没有密码时，远程 Ivaldi 会对该网络中的所有设备开放。',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': '用于保护远程 Ivaldi 界面的密码。Ivaldi 会把它设置到为你启动的服务器上。',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': '远程机器上已在运行的 Ivaldi 服务器的密码，用于登录。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安装 Ivaldi',
  'settings.remoteInstances.page.phase.updatingOpenChamber': '正在更新 Ivaldi',
  ...
  'settings.providers.page.custom.field.apiKey.info': '保存在 OpenCode 认证中，而非 Ivaldi。使用 {env:VAR_NAME} 可从环境变量读取密钥。',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '密钥将直接发送给 OpenCode，不会被 Ivaldi 存储。',
  ...
  'settings.openchamber.defaults.field.provider': '提供商',
  ...
  'settings.openchamber.defaults.field.defaultAssistant': '默认助手',
  ...
  'settings.github.page.flow.title': '授权 Ivaldi',
  ...
  'settings.github.page.ghCli.fallbackDescription': '在 Ivaldi 认证被移除时可作为备用',
  ...
  'settings.notifications.page.testNotification.body': '这是来自 Ivaldi 的测试通知。',
  ...
  'settings.voice.page.tooltip.sttLocal': '在 Ivaldi 服务器上本地转写。模型自动下载，无需 API 密钥。',
  'settings.voice.page.tooltip.localTts': '在 Ivaldi 服务器上本地合成语音（Kokoro，英语）。模型自动下载，无需 API 密钥。',
  ...
  'settings.voice.page.field.optional': '可选',
