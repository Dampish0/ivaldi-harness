...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. Ivaldi nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.common.state.loadFailed': 'Nie udało się wczytać tej sekcji. Jeśli są dostępne, wyświetlane są ostatnio wczytane dane.',
  ...
  'settings.gitIdentities.page.state.loadFailed': 'Nie udało się wczytać tożsamości Git. Spróbuj ponownie, aby odświeżyć tę sekcję.',
  ...
  'settings.github.page.flow.title': 'Autoryzuj Ivaldi',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Dostępne jako rezerwa, jeśli uwierzytelnienie Ivaldi zostanie usunięte',
  ...
  'settings.notifications.page.testNotification.body': 'To jest powiadomienie testowe z Ivaldi.',
  ...
  'settings.openchamber.about.title': 'O Ivaldi',
  ...
  'settings.openchamber.defaults.field.defaultAssistant': 'Domyślny asystent',
  'settings.openchamber.defaults.field.defaultModel': 'Domyślny Model',
  'settings.openchamber.defaults.field.provider': 'Dostawca',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj Ivaldi przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj Ivaldi przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj Ivaldi na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj Ivaldi na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu Ivaldi nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Zamykaj Ivaldi do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje Ivaldi w zasobniku systemowym, gdy główne okno zostanie zamknięte. Minimalizacja pozostawia okno na pasku zadań.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy Ivaldi jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy Ivaldi jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Ivaldi pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.keyboardShortcuts.action.reopen_session_tab.label': "Otwórz ponownie zamkniętą kartę sesji",
  ...
  'settings.openchamber.tools.title': 'Narzędzia Ivaldi',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Narzędzie Ivaldi Web',
  'settings.openchamber.tools.field.agentWebToolAria': 'Włącz narzędzie Ivaldi Web',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Pozwól agentom oglądać stronę w panelu przeglądarki Ivaldi i wchodzić z nią w interakcję: otwierać adres URL, czytać treść, klikać, pisać, przewijać i przełączać między układem mobilnym a desktopowym. Dodaje krótki opis narzędzia do każdej sesji. Zastosowane po ponownym uruchomieniu OpenCode.',
  ...
  'settings.page.appearance.description': 'Dostosuj wygląd i działanie Ivaldi.',
  'settings.page.behavior.title': 'Zachowanie agenta',
  ...
  'settings.page.work.chat.description': 'Skonfiguruj wygląd czatu, rozumowanie, wersje robocze i retencję.',
  'settings.page.work.chat.retention.title': 'Retencja czatów',
  'settings.page.work.chat.retention.tooltip': 'Automatycznie archiwizuj lub usuwaj nieaktywne czaty na podstawie ostatniej aktywności. Zachowuje 5 najnowszych czatów.',
  'settings.page.work.chat.retention.whenChatsExpire': 'Gdy czaty wygasną',
  'settings.page.work.chat.retention.toast.noneEligibleArchive': 'Brak czatów do zarchiwizowania',
  'settings.page.work.chat.retention.toast.noneEligibleDelete': 'Brak czatów do usunięcia',
  'settings.page.work.chat.retention.toast.archivedCount': 'Zarchiwizowano {count} czat(y)',
  'settings.page.work.chat.retention.toast.deletedCount': 'Usunięto {count} czat(y)',
  'settings.page.work.chat.retention.toast.failedArchiveCount': 'Nie udało się zarchiwizować {count} czatów',
  'settings.page.work.chat.retention.toast.failedDeleteCount': 'Nie udało się usunąć {count} czatów',
  ...
  'settings.page.providers.title': 'Modele i dostawcy',
  ...
  'settings.page.work.ai.description': 'Wybierz model, poziom rozumowania i asystenta używane w nowych czatach.',
  'settings.page.work.ai.defaultsTitle': 'Domyślne ustawienia nowych czatów',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez Ivaldi.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez Ivaldi. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
  ...
  'settings.remoteInstances.page.description': 'Połącz się z inną maszyną przez SSH i otwórz tam Ivaldi.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'Jak Ivaldi ma zostać umieszczony na zdalnej maszynie, gdy aplikacja uruchamia go za Ciebie.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Wybierz, czy Ivaldi ma uruchomić serwer za Ciebie, czy połączyć się z już działającym.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port, którego Ivaldi używa na zdalnej maszynie. Zostaw puste, aby wybrać automatycznie.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Najpierw podaj port zdalny. W trybie „Już uruchomiony” Ivaldi musi wiedzieć, na którym porcie nasłuchuje serwer.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Pozwól innym urządzeniom w sieci zdalnej maszyny otwierać ten Ivaldi bezpośrednio, bez tunelu SSH. Wymagane jest hasło interfejsu.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Każdy w tej sieci dotrze do zdalnego Ivaldi. Chroni go tylko hasło interfejsu poniżej.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Najpierw ustaw hasło interfejsu. Bez niego zdalny Ivaldi byłby otwarty dla każdego urządzenia w tej sieci.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Hasło chroniące zdalny interfejs Ivaldi. Ivaldi ustawia je na serwerze, który uruchamia za Ciebie.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Hasło serwera Ivaldi już działającego na zdalnej maszynie, używane do zalogowania się.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie Ivaldi',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie Ivaldi',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Opcjonalne dane logowania dla SSH i zdalnego interfejsu Ivaldi.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Ivaldi działa na zdalnej maszynie. Te ustawienia dotyczą wyłącznie adresu na tym komputerze, który prowadzi do niej przez tunel SSH.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Ivaldi na zdalnej maszynie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Wybierz, jak Ivaldi ma działać po połączeniu SSH.',
  ...
  'settings.remoteInstances.direct.title': 'Inne serwery Ivaldi',
  'settings.remoteInstances.headerSwitcher.label': 'Pokaż bieżącą instancję w nagłówku',
  'settings.remoteInstances.headerSwitcher.info': 'Pokazuje aktywną instancję Ivaldi w nagłówku aplikacji i umożliwia przełączanie instancji z tego miejsca.',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Dodaj inny serwer Ivaldi przez URL. Użyj tego, gdy serwer już działa i masz token połączenia.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Utwórz bezpieczny link lub token, aby Ivaldi Desktop mógł połączyć się z tym serwerem.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Kod QR połączenia Ivaldi',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Powiększ kod QR',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Zeskanuj to aplikacją Ivaldi na drugim urządzeniu. Jednorazowy i wygasa.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Działa w domu i poza nim. Poza domem ruch przechodzi przez Ivaldi Private Relay — szyfrowany end-to-end tunel. Bez konfiguracji.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Zeskanuj ten kod QR aplikacją Ivaldi na drugim urządzeniu.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Dodaj repozytorium Git jako nowe źródło katalogu. Ivaldi przeskanuje je w poszukiwaniu folderów zawierających',
  ...
  'settings.skills.sidebar.state.loadFailed': 'Nie udało się wczytać umiejętności.',
  'settings.skills.page.state.loadFailed': 'Nie udało się wczytać tej umiejętności.',
  'settings.skills.page.state.refreshFailed': 'Nie udało się odświeżyć tej umiejętności. Wyświetlana jest ostatnio wczytana wersja.',
  'settings.skills.page.actions.retry': 'Ponów',
  ...
  'settings.view.nav.group.opencode': 'AI i agenci',
  'settings.view.nav.group.advanced': 'Zaawansowane',
  'settings.view.nav.group.tools': 'Narzędzia',
  'settings.view.nav.group.content': 'Prompty',
  ...
  'settings.voice.page.field.optional': 'Opcjonalne',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Transkrypcja lokalna na serwerze Ivaldi. Modele pobierają się automatycznie; klucz API nie jest potrzebny.',
  'settings.voice.page.tooltip.localTts': 'Lokalna synteza na serwerze Ivaldi (Kokoro, angielski). Model pobiera się automatycznie; klucz API nie jest potrzebny.',
  ...
  'settings.window.description': 'Okno ustawień Ivaldi.',
