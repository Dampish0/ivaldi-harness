...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '대시보드 URL에서 워크스페이스 ID를, 브라우저 개발자 도구에서 auth 쿠키를 복사하세요. Ivaldi는 브라우저 쿠키 저장소를 검색하지 않습니다.',
  ...
  'settings.window.description': 'Ivaldi 설정 창입니다.',
  ...
  'settings.view.nav.group.opencode': 'AI 및 에이전트',
  'settings.view.nav.group.advanced': '고급',
  'settings.view.nav.group.tools': '도구',
  'settings.view.nav.group.content': '프롬프트',
  'settings.view.nav.group.system': '시스템',
  'settings.page.projects.title': '프로젝트',
  'settings.page.remoteInstances.title': '원격 인스턴스',
  'settings.page.providers.title': '모델 및 프로바이더',
  ...
  'settings.page.appearance.description': 'Ivaldi의 모양과 느낌을 맞춤 설정하세요.',
  'settings.page.chat.title': '채팅',
  'settings.page.chat.description': '메시지와 도구가 표시되는 방식을 구성합니다.',
  'settings.page.work.chat.description': '채팅 모양, 추론, 초안 및 보존 설정을 구성합니다.',
  'settings.page.work.chat.retention.title': '채팅 보존',
  'settings.page.work.chat.retention.tooltip': '마지막 활동을 기준으로 비활성 채팅을 자동으로 보관하거나 삭제합니다. 최근 5개 채팅은 유지됩니다.',
  'settings.page.work.chat.retention.whenChatsExpire': '채팅 보존 기간이 끝날 때',
  'settings.page.work.chat.retention.toast.noneEligibleArchive': '보관할 수 있는 채팅이 없습니다',
  'settings.page.work.chat.retention.toast.noneEligibleDelete': '삭제할 수 있는 채팅이 없습니다',
  'settings.page.work.chat.retention.toast.archivedCount': '채팅 {count}개를 보관했습니다',
  'settings.page.work.chat.retention.toast.deletedCount': '채팅 {count}개를 삭제했습니다',
  'settings.page.work.chat.retention.toast.failedArchiveCount': '채팅 {count}개를 보관하지 못했습니다',
  'settings.page.work.chat.retention.toast.failedDeleteCount': '채팅 {count}개를 삭제하지 못했습니다',
  ...
  'settings.page.work.ai.description': '새 채팅에 사용할 모델, 사고 수준, 어시스턴트를 선택합니다.',
  'settings.page.work.ai.defaultsTitle': '새 채팅 기본값',
  ...
  'settings.remoteInstances.direct.title': '다른 Ivaldi 서버',
  'settings.remoteInstances.headerSwitcher.label': '현재 인스턴스를 헤더에 표시',
  'settings.remoteInstances.headerSwitcher.info': '활성 Ivaldi 인스턴스를 앱 헤더에 표시하고 여기에서 인스턴스를 전환할 수 있습니다.',
  'settings.remoteInstances.direct.description': '이 앱이 전환할 수 있는 서버입니다. 다른 서버의 페어링 링크를 가져오거나 주소로 추가하세요.',
  'settings.remoteInstances.direct.addDialog.description': 'URL로 다른 Ivaldi 서버를 추가합니다. 서버가 이미 실행 중이고 연결 토큰이 있을 때 사용하세요.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Ivaldi Desktop이 이 서버에 연결할 수 있도록 안전한 링크나 토큰을 만듭니다.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '다른 기기의 Ivaldi 앱으로 스캔하세요. 일회용이며 만료됩니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '집과 밖 어디서나 작동합니다. 밖에서는 종단간 암호화 터널인 Ivaldi Private Relay를 통해 연결됩니다. 설정이 필요 없습니다.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '다른 기기의 Ivaldi 앱으로 이 QR 코드를 스캔하세요.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Ivaldi가 서버를 대신 시작할지, 이미 실행 중인 서버에 연결할지 선택하세요.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Ivaldi가 원격 머신에서 사용할 포트. 비워 두면 자동으로 선택됩니다.',
  ...
  'settings.common.state.loadFailed': '이 섹션을 불러올 수 없습니다. 가능한 경우 마지막으로 불러온 데이터를 표시합니다.',
  ...
  'settings.openchamber.about.title': 'Ivaldi 정보',
  ...
  'settings.page.behavior.title': '에이전트 동작',
  ...
  'settings.gitIdentities.page.state.loadFailed': 'Git ID를 불러올 수 없습니다. 다시 시도하여 이 섹션을 새로 고치세요.',
  ...
  'settings.skills.sidebar.state.loadFailed': '스킬을 불러올 수 없습니다.',
  'settings.skills.page.state.loadFailed': '이 스킬을 불러올 수 없습니다.',
  'settings.skills.page.state.refreshFailed': '이 스킬을 새로 고칠 수 없습니다. 마지막으로 불러온 버전을 표시합니다.',
  'settings.skills.page.actions.retry': '다시 시도',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Git 저장소를 새 카탈로그 소스로 추가합니다. Ivaldi는 다음을 포함하는 폴더를 스캔합니다:',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '로그인 시 Ivaldi 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '로그인 시 Ivaldi 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '창을 열지 않고 백그라운드에서 앱을 시작합니다. 데스크톱 상태 아이콘으로 열 수 있습니다.',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'macOS 메뉴 막대에 Ivaldi 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '메뉴 막대에 Ivaldi 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '앱을 다시 시작해야 합니다. 끄면 Ivaldi가 메뉴 막대 항목을 만들지 않으며 세션, 승인 및 사용량 업데이트도 실행하지 않습니다.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Ivaldi를 시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '메인 창을 닫아도 Ivaldi가 시스템 트레이에서 계속 실행됩니다. 최소화하면 창은 작업 표시줄에 남습니다.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Ivaldi가 실행되는 동안 컴퓨터 절전 방지',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Ivaldi가 실행되는 동안 컴퓨터 절전 방지',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Ivaldi는 다시 시작 후 비밀번호를 요청하고, 이후 로그인 세션이 만료되면 다시 요청합니다. 기본 12시간, 이 디바이스 신뢰 선택 시 7일입니다. 로그인을 끄려면 비워 두세요.',
  ...
  'settings.openchamber.tools.title': 'Ivaldi 도구',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Ivaldi Web 도구',
  'settings.openchamber.tools.field.agentWebToolAria': 'Ivaldi Web 도구 활성화',
  'settings.openchamber.tools.field.agentWebToolInfo': '에이전트가 Ivaldi 브라우저 패널에서 페이지를 확인하고 조작할 수 있습니다. URL 열기, 내용 읽기, 클릭, 입력, 스크롤, 모바일과 데스크톱 레이아웃 전환이 가능합니다. 각 세션에 작은 도구 설명이 추가됩니다. OpenCode를 다시 시작하면 적용됩니다.',
  ...
  'settings.openchamber.keyboardShortcuts.action.reopen_session_tab.label': "닫은 세션 탭 다시 열기",
  ...
  'settings.remoteInstances.page.description': 'SSH로 다른 컴퓨터에 연결하고 그곳에서 Ivaldi를 엽니다.',
  ...
  'settings.remoteInstances.page.section.remoteServer': '원격 컴퓨터의 Ivaldi',
  'settings.remoteInstances.page.section.remoteServerDescription': 'SSH 연결 후 Ivaldi를 어떻게 실행할지 선택하세요.',
  'settings.remoteInstances.page.section.mainTunnel': '이 컴퓨터에서의 접근',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Ivaldi는 원격 머신에서 실행됩니다. 이 설정은 SSH 터널을 통해 그곳으로 연결되는 이 컴퓨터의 주소만 제어합니다.',
  'settings.remoteInstances.page.section.authentication': '인증',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH와 원격 Ivaldi UI를 위한 인증 정보입니다.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '이 앱이 대신 시작할 때 Ivaldi를 원격 컴퓨터에 배치하는 방법입니다.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': '먼저 원격 포트를 지정하세요. "이미 실행 중" 모드에서는 서버가 어떤 포트에서 대기하는지 Ivaldi가 알아야 합니다.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': '원격 머신 네트워크의 다른 기기가 SSH 터널 없이 이 Ivaldi를 직접 열 수 있게 합니다. UI 비밀번호가 필요합니다.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': '그 네트워크의 누구나 원격 Ivaldi에 접근할 수 있습니다. 아래 UI 비밀번호만이 이를 보호합니다.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': '먼저 UI 비밀번호를 설정하세요. 없으면 원격 Ivaldi가 그 네트워크의 모든 기기에 열리게 됩니다.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': '원격 Ivaldi 화면을 보호할 비밀번호. Ivaldi가 대신 시작하는 서버에 이 값을 설정합니다.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': '원격 머신에서 이미 실행 중인 Ivaldi 서버에 로그인할 때 쓰는 비밀번호.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Ivaldi 설치 중',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Ivaldi 업데이트 중',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Ivaldi가 아니라 OpenCode 인증에 저장됩니다. 환경 변수에서 읽으려면 {env:VAR_NAME}을 사용하세요.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '키는 OpenCode로 직접 전송되며 Ivaldi에 저장되지 않습니다.',
  ...
  'settings.openchamber.defaults.field.provider': '제공업체',
  ...
  'settings.openchamber.defaults.field.defaultAssistant': '기본 어시스턴트',
  ...
  'settings.github.page.flow.title': 'Ivaldi 권한 부여',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Ivaldi 인증이 제거된 경우 대체로 사용 가능',
  ...
  'settings.notifications.page.testNotification.body': 'Ivaldi의 테스트 알림입니다.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Ivaldi 서버에서 로컬로 변환합니다. 모델은 자동으로 다운로드되며 API 키가 필요 없습니다.',
  'settings.voice.page.tooltip.localTts': 'Ivaldi 서버에서 로컬로 음성을 합성합니다(Kokoro, 영어). 모델은 자동으로 다운로드되며 API 키가 필요 없습니다.',
  ...
  'settings.voice.page.field.optional': '선택 사항',
