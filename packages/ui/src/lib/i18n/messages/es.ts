...
export const dict: Partial<Record<I18nKey, string>> = {
  ...
  ...permissionModeMessages.es,
  ...sharedSettingsMessages.es,
  ...
  "profile.setup.title": "¿Cómo te llamamos?",
  "profile.setup.description": "Elige un nombre para tu perfil de Ivaldi. Puedes cambiarlo más tarde.",
  "profile.name.label": "Tu nombre",
  "profile.name.placeholder": "Nombre o nombre de usuario",
  "profile.actions.continue": "Continuar",
  "profile.actions.save": "Guardar",
  "profile.actions.edit": "Editar perfil",
  "profile.fallback": "Tu perfil",
  "profile.error.invalid": "Introduce un nombre de entre 1 y 64 caracteres.",
  ...
  "mobile.connect.welcome.title": "Conéctate a Ivaldi",
  ...
  "mobile.connect.password.placeholder": "Contraseña de Ivaldi",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de Ivaldi.",
  ...
  "mobile.connect.relay.badge": "a través de Ivaldi Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de Ivaldi.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de Ivaldi",
  ...
  "sessions.sidebar.activity.projectsTitle": "Proyectos",
  ...
  "header.sessionTabs.scrollLeftAria": "Desplazar pestañas a la izquierda",
  "header.sessionTabs.scrollRightAria": "Desplazar pestañas a la derecha",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de Ivaldi al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está Ivaldi y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja Ivaldi. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Ivaldi: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en Ivaldi. Descárgalo para abrirlo con otra aplicación.",
  ...
  "filesView.tree.actions.moreAria": "Más acciones de archivo",
  ...
  "directoryExplorerDialog.pathInput.label": "Carpeta del proyecto",
  "directoryExplorerDialog.work.description": "Reúne los chats y archivos relacionados en un proyecto.",
  "directoryExplorerDialog.work.existingFolder": "Usar carpeta existente",
  "directoryExplorerDialog.work.newProject": "Crear nuevo proyecto",
  "directoryExplorerDialog.work.createProject": "Crear proyecto",
  "directoryExplorerDialog.work.projectName": "Nombre del proyecto",
  "directoryExplorerDialog.work.namePlaceholder": "p. ej. Campaña de verano",
  "directoryExplorerDialog.work.nameHint": "Se creará una carpeta nueva con este nombre.",
  "directoryExplorerDialog.work.nameExists": "Ya existe una carpeta con este nombre. Elige otro nombre o usa la carpeta existente.",
  "directoryExplorerDialog.work.invalidName": "Introduce un nombre de carpeta válido sin barras ni caracteres especiales.",
  "directoryExplorerDialog.work.saveLocation": "Guardar en",
  "directoryExplorerDialog.work.chooseFolderHint": "Elige la carpeta que contiene los archivos de tu proyecto.",
  "directoryExplorerDialog.work.selectFolder": "Usar esta carpeta",
  "directoryExplorerDialog.actions.chooseFolder": "Buscar carpetas...",
  "directoryExplorerDialog.actions.openingPicker": "Abriendo...",
  "directoryExplorerDialog.title": "Añadir proyecto",
  "directoryExplorerDialog.description": "Abre una carpeta para usarla como proyecto o introduce una ruta nueva para crear una.",
  ...
  "directoryExplorerDialog.actions.addProject": "Añadir esta carpeta",
  ...
  "directoryExplorerDialog.actions.createAndAdd": "Crear carpeta y añadir",
  "directoryExplorerDialog.actions.alreadyAdded": "Carpeta ya añadida",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Ivaldi necesita acceso a esta carpeta.",
  ...
  "directoryExplorerDialog.footer.select": "Abrir carpeta",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de Ivaldi {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Ivaldi, el estado del runtime, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Ivaldi de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Ivaldi",
  "header.actions.openAppMenuAria": "Abrir menú de Ivaldi",
  ...
  "chat.emptyState.opencodeUnreachable": "El runtime de Ivaldi no está accesible",
  "chat.emptyState.startNewChat": "Iniciar una nueva conversación",
  "chat.work.newChat": "Nuevo chat",
  "chat.work.startNewFromAnswer": "Nuevo chat a partir de esta respuesta",
  "chat.work.keepWorkingUntilComplete": "Seguir trabajando hasta terminar",
  "chat.work.showMore": "Mostrar más",
  "chat.work.showFewer": "Mostrar menos",
  "chat.work.searchChats": "Buscar chats",
  "chat.work.searchChatsPlaceholder": "Buscar chats...",
  "chat.work.selectChats": "Seleccionar chats",
  "chat.work.noRecentChats": "No hay chats recientes",
  "chat.work.untitledChat": "Chat sin título",
  "chat.work.archive.searchPlaceholder": "Buscar chats archivados",
  "chat.work.archive.countSingle": "{count} chat archivado",
  "chat.work.archive.countPlural": "{count} chats archivados",
  "chat.work.archive.emptyNoArchived": "No hay chats archivados",
  "chat.work.archive.emptyNoMatches": "No hay chats archivados que coincidan",
  "chat.work.archive.deleteProject": "Eliminar todos los chats archivados de este proyecto",
  "chat.work.archive.deleteProjectAria": "Eliminar todos los chats archivados de {label}",
  "chat.work.scheduledTasks.description": "Tareas que inician un nuevo chat y envían el prompt configurado según tu programación.",
  "chat.work.scheduledTasks.editorDescription": "Elige cuándo debe iniciar esta tarea un nuevo chat y enviar su prompt.",
  "chat.work.scheduledTasks.goalAria": "Ejecutar esta tarea como objetivo hasta completarla",
  "chat.work.mobile.noProjectsDescription": "Añade un proyecto para trabajar con sus archivos y contexto.",
  "chat.work.mobile.renameError": "No se pudo cambiar el nombre del chat",
  "chat.work.mobile.editOrderHint": "Arrastra el control para reordenar los proyectos. Toca la marca para terminar.",
  "chat.emptyState.draftTitle": "What are we working on?",
  "chat.emptyState.draftTitleWithProject": "What are we working on in {project}?",
  "chat.emptyState.workDraftTitle": "¿En qué puedo ayudarte?",
  "chat.emptyState.workDraftTitleWithProject": "¿En qué puedo ayudarte en {project}?",
  "chat.emptyState.workDraftSubtitle": "Puedo usar tus archivos, la web, integraciones, herramientas MCP, plugins y habilidades cuando sea útil.",
  ...
  "chat.draftPresets.researchTopic.label": "Investigar un tema",
  "chat.draftPresets.draftDocument.label": "Redactar un documento",
  "chat.draftPresets.analyzeFiles.label": "Analizar archivos",
  "chat.draftPresets.projectPlan.label": "Planificar un proyecto",
  "chat.draftPresets.summarizeProject.label": "Resumir un proyecto",
  ...
  "chat.work.draftStarters.add": "Añadir sugerencia",
  "chat.work.draftStarters.searchPlaceholder": "Buscar acciones y habilidades…",
  "chat.work.draftStarters.empty": "No hay nada más que añadir",
  "chat.work.draftStarters.sectionBuiltIn": "Acciones sugeridas",
  "chat.work.draftStarters.sectionCommands": "Acciones",
  "chat.work.draftStarters.sectionSkills": "Habilidades",
  "chat.work.draftStarters.remove": "Quitar sugerencia",
  ...
  "chat.toast.opencodeRestartInterrupted.description": "El runtime de Ivaldi se reinició mientras aún se estaba generando una respuesta. Envía un mensaje para continuar.",
  ...
  "chat.chatInput.commandChip.removeAria": "Quitar {command}",
  "chat.chatInput.commandChip.planLabel": "Plan",
  "chat.chatInput.commandChip.goalLabel": "Objetivo",
  ...
  "chat.activity.label": "Actividad",
  "chat.activity.more": "+{count} más...",
  ...
  "chat.permissionCard.replaceAllOccurrences": "Reemplazar todas las coincidencias",
  ...
  "openCodeStatusDialog.title": "Estado del runtime de Ivaldi",
  "openCodeStatusDialog.description": "Inspecciona el estado actual del runtime de Ivaldi y sus diagnósticos.",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres Ivaldi desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Ivaldi",
  ...
  "multiRun.window.description": "Ventana de Ivaldi Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a Ivaldi",
  ...
  "onboarding.localSetup.title": "Configuración de Ivaldi",
  "onboarding.localSetup.description": "Ivaldi necesita el runtime de la CLI de OpenCode para continuar.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Ivaldi no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "Instala el runtime que Ivaldi usa para las sesiones locales del agente.",
  ...
  "onboarding.localSetup.status.watching": "Esperando el runtime de Ivaldi",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Ivaldi y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Ivaldi para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Ivaldi o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Ivaldi. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Ivaldi pero no es compatible con esta versión de la app. Actualiza Ivaldi en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Ivaldi. Verifica que la dirección apunte a un servidor Ivaldi.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "Runtime local de Ivaldi no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "El runtime local del agente no pudo iniciarse o no está instalado. Instala el runtime de la CLI de OpenCode o conéctate a un servidor Ivaldi remoto.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Ivaldi. Verifica que la dirección apunte a un servidor Ivaldi.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Ivaldi en \"{host}\" no es compatible con esta versión de la app. Actualiza Ivaldi en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "Ivaldi no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Ivaldi...",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén Ivaldi abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de Ivaldi",
