...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copie o ID da URL do painel e o cookie auth das ferramentas do navegador. O Ivaldi nunca examina os cookies do navegador.',
  ...
  "settings.window.description": "Janela de configurações do Ivaldi.",
  ...
  "settings.view.nav.group.opencode": "IA e agentes",
  "settings.view.nav.group.advanced": "Avançado",
  "settings.view.nav.group.tools": "Ferramentas",
  "settings.view.nav.group.content": "Prompts",
  "settings.view.nav.group.system": "Sistema",
  "settings.page.projects.title": "Projetos",
  "settings.page.remoteInstances.title": "Instâncias remotas",
  "settings.page.providers.title": "Modelos e provedores",
  ...
  "settings.page.appearance.description": "Personalize a aparência e a sensação do Ivaldi.",
  "settings.page.chat.title": "Chat",
  "settings.page.chat.description": "Configure como as mensagens e as ferramentas são exibidas.",
  "settings.page.work.chat.description": "Configure a aparência do chat, o raciocínio, os rascunhos e a retenção.",
  "settings.page.work.chat.retention.title": "Retenção de chats",
  "settings.page.work.chat.retention.tooltip": "Arquive ou exclua automaticamente chats inativos com base na última atividade. Mantém os 5 chats mais recentes.",
  "settings.page.work.chat.retention.whenChatsExpire": "Quando os chats expirarem",
  "settings.page.work.chat.retention.toast.noneEligibleArchive": "Nenhum chat disponível para arquivamento",
  "settings.page.work.chat.retention.toast.noneEligibleDelete": "Nenhum chat disponível para exclusão",
  "settings.page.work.chat.retention.toast.archivedCount": "{count} chat(s) arquivado(s)",
  "settings.page.work.chat.retention.toast.deletedCount": "{count} chat(s) excluído(s)",
  "settings.page.work.chat.retention.toast.failedArchiveCount": "Falha ao arquivar {count} chat(s)",
  "settings.page.work.chat.retention.toast.failedDeleteCount": "Falha ao excluir {count} chat(s)",
  ...
  "settings.page.work.ai.description": "Escolha o modelo, o nível de raciocínio e o assistente usados em novos chats.",
  "settings.page.work.ai.defaultsTitle": "Padrões para novos chats",
  ...
  "settings.remoteInstances.direct.title": "Outros servidores Ivaldi",
  "settings.remoteInstances.headerSwitcher.label": "Mostrar instância atual no cabeçalho",
  "settings.remoteInstances.headerSwitcher.info": "Mostra a instância ativa do Ivaldi no cabeçalho do aplicativo e permite alternar instâncias por ali.",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Adicione outro servidor Ivaldi por URL. Use isto quando o servidor já estiver em execução e você tiver um token de conexão.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crie um link ou token seguro para que o Ivaldi Desktop possa se conectar a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "Ivaldi connection QR code",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Ampliar código QR",
  "settings.remoteInstances.clientAuth.qrScanHint": "Escaneie com o app Ivaldi no seu outro dispositivo. É de uso único e expira.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona em casa e fora. Fora de casa o tráfego passa pelo Ivaldi Private Relay, um túnel criptografado de ponta a ponta. Sem configuração.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escaneie este código QR com o app Ivaldi no seu outro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Escolha se o Ivaldi deve iniciar o servidor para você ou se conectar a um que já está em execução.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Porta que o Ivaldi usa na máquina remota. Deixe vazio para escolher automaticamente.",
  ...
  "settings.common.state.loadFailed": "Não foi possível carregar esta seção. Os últimos dados carregados são exibidos quando disponíveis.",
  ...
  "settings.openchamber.about.title": "Sobre o Ivaldi",
  ...
  "settings.page.behavior.title": "Comportamento do agente",
  ...
  "settings.gitIdentities.page.state.loadFailed": "Não foi possível carregar as identidades do Git. Tente novamente para atualizar esta seção.",
  ...
  "settings.skills.sidebar.state.loadFailed": "Não foi possível carregar as habilidades.",
  "settings.skills.page.state.loadFailed": "Não foi possível carregar esta habilidade.",
  "settings.skills.page.state.refreshFailed": "Não foi possível atualizar esta habilidade. A última versão carregada está sendo exibida.",
  "settings.skills.page.actions.retry": "Tentar novamente",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Adicione um repositório Git como nova origem de catálogo. O Ivaldi escaneará para encontrar pastas que contenham",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar o Ivaldi ao fazer login",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar o Ivaldi ao fazer login",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar o Ivaldi na barra de menus do macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar o Ivaldi na barra de menus",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Exige reiniciar o aplicativo. Quando desativado, o Ivaldi não cria o item da barra de menus nem executa as atualizações de sessões, aprovações e uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Fechar o Ivaldi na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Fechar na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantém o Ivaldi em execução na bandeja do sistema quando a janela principal é fechada. Ao minimizar, a janela permanece na barra de tarefas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Manter o computador ativo enquanto o Ivaldi estiver em execução",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Manter o computador ativo enquanto o Ivaldi estiver em execução",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "O Ivaldi pede após reiniciar e depois quando a sessão expira: em 12 horas, ou 7 dias com Confiar neste dispositivo. Deixe vazio para desativar o login.",
  ...
  "settings.openchamber.tools.title": "Ferramentas do Ivaldi",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Ferramenta Ivaldi Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Ativar a ferramenta Ivaldi Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permita que agentes vejam a página no painel de navegador do Ivaldi e interajam com ela: abrir uma URL, ler o conteúdo, clicar, digitar, rolar e alternar entre layout móvel e desktop. Adiciona uma pequena descrição de ferramenta a cada sessão. Aplicado após reiniciar o OpenCode.",
  ...
  "settings.openchamber.keyboardShortcuts.action.reopen_session_tab.label": "Reabrir aba de sessão fechada",
  ...
  "settings.remoteInstances.page.description": "Conecte-se a outra máquina por SSH e abra o Ivaldi lá.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Ivaldi na máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Escolha como o Ivaldi deve rodar depois que o SSH conectar.",
  "settings.remoteInstances.page.section.mainTunnel": "Acesso a partir deste computador",
  "settings.remoteInstances.page.section.mainTunnelDescription": "O Ivaldi roda na máquina remota. Estas opções controlam apenas o endereço neste computador que leva até ela pelo túnel SSH.",
  "settings.remoteInstances.page.section.authentication": "Autenticação",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciais opcionais para SSH e para a interface de usuário do Ivaldi remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Como o Ivaldi deve ser colocado na máquina remota quando este app o inicia para você.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Defina primeiro uma porta remota. No modo “Já em execução”, o Ivaldi precisa saber em qual porta o servidor escuta.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Permitir que outros dispositivos da rede da máquina remota abram este Ivaldi diretamente, sem o túnel SSH. É obrigatória uma senha da interface.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Qualquer pessoa nessa rede alcança o Ivaldi remoto. Só a senha da interface abaixo o protege.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Defina primeiro uma senha da interface. Sem ela, o Ivaldi remoto ficaria aberto a todos os dispositivos daquela rede.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Senha que protegerá a interface remota do Ivaldi. O Ivaldi a define no servidor que inicia para você.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Senha do servidor Ivaldi que já está em execução na máquina remota, usada para entrar nele.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Instalando Ivaldi",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Atualizando Ivaldi",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Armazenada na autenticação do OpenCode, não pelo Ivaldi. Use {env:VAR_NAME} para ler uma chave do ambiente.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "As chaves são enviadas diretamente ao OpenCode e nunca são armazenadas no Ivaldi.",
  ...
  "settings.openchamber.defaults.field.provider": "Provedor",
  ...
  "settings.openchamber.defaults.field.defaultAssistant": "Assistente padrão",
  ...
  "settings.github.page.flow.title": "Autorizar Ivaldi",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponível como alternativa se a autenticação do Ivaldi for removida",
  ...
  "settings.notifications.page.testNotification.body": "Esta é uma notificação de teste do Ivaldi.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcrição local no servidor do Ivaldi. Os modelos são baixados automaticamente; não é necessária chave de API.",
  "settings.voice.page.tooltip.localTts": "Síntese local no servidor do Ivaldi (Kokoro, inglês). O modelo é baixado automaticamente; não é necessária chave de API.",
  ...
  "settings.voice.page.field.optional": "Opcional",
