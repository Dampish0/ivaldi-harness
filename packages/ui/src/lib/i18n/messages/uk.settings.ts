...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Скопіюйте ID робочого простору з URL панелі, а cookie auth з інструментів розробника браузера. Ivaldi ніколи не сканує сховище cookie браузера.',
  ...
  "settings.window.description": "Вікно налаштувань Ivaldi.",
  ...
  "settings.view.nav.group.opencode": "ШІ та агенти",
  "settings.view.nav.group.advanced": "Розширені",
  "settings.view.nav.group.tools": "Інструменти",
  "settings.view.nav.group.content": "Промпти",
  "settings.view.nav.group.system": "Система",
  "settings.page.projects.title": "Проєкти",
  "settings.page.remoteInstances.title": "Віддалені інстанси",
  "settings.page.providers.title": "Моделі та провайдери",
  ...
  "settings.page.appearance.description": "Налаштуйте вигляд і відчуття Ivaldi.",
  "settings.page.chat.title": "Чат",
  "settings.page.chat.description": "Налаштуйте відображення повідомлень і інструментів.",
  "settings.page.work.chat.description": "Налаштуйте вигляд чату, міркування, чернетки та зберігання.",
  "settings.page.work.chat.retention.title": "Зберігання чатів",
  "settings.page.work.chat.retention.tooltip": "Автоматично архівуйте або видаляйте неактивні чати за останньою активністю. Зберігаються 5 найновіших чатів.",
  "settings.page.work.chat.retention.whenChatsExpire": "Коли термін зберігання чатів спливає",
  "settings.page.work.chat.retention.toast.noneEligibleArchive": "Немає чатів для архівування",
  "settings.page.work.chat.retention.toast.noneEligibleDelete": "Немає чатів для видалення",
  "settings.page.work.chat.retention.toast.archivedCount": "Заархівовано чатів: {count}",
  "settings.page.work.chat.retention.toast.deletedCount": "Видалено чатів: {count}",
  "settings.page.work.chat.retention.toast.failedArchiveCount": "Не вдалося заархівувати чатів: {count}",
  "settings.page.work.chat.retention.toast.failedDeleteCount": "Не вдалося видалити чатів: {count}",
  ...
  "settings.page.work.ai.description": "Виберіть модель, рівень міркування та асистента для нових чатів.",
  "settings.page.work.ai.defaultsTitle": "Типові налаштування нових чатів",
  ...
  "settings.remoteInstances.direct.title": "Інші сервери Ivaldi",
  "settings.remoteInstances.headerSwitcher.label": "Показувати поточний інстанс у заголовку",
  "settings.remoteInstances.headerSwitcher.info": "Показує активний інстанс Ivaldi у заголовку застосунку та дає змогу перемикати інстанси звідти.",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Додайте інший сервер Ivaldi за URL. Використовуйте це, коли сервер уже запущений і у вас є токен підключення.",
  ...
  "settings.remoteInstances.clientAuth.description": "Створіть безпечне посилання або токен, щоб Ivaldi Desktop міг підключитися до цього сервера.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "QR-код підключення Ivaldi",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Збільшити QR-код",
  "settings.remoteInstances.clientAuth.qrScanHint": "Скануй це застосунком Ivaldi на іншому пристрої. Одноразовий і має термін дії.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Працює вдома і поза домом. Поза домом трафік іде через Ivaldi Private Relay — наскрізно зашифрований тунель. Нічого налаштовувати не треба.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Відскануйте цей QR-код застосунком Ivaldi на іншому пристрої.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Виберіть, чи Ivaldi має запустити сервер для вас, чи підключитися до вже запущеного.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Порт, який Ivaldi займе на віддаленій машині. Лишіть порожнім, щоб вибрався автоматично.",
  ...
  "settings.common.state.loadFailed": "Не вдалося завантажити цей розділ. За наявності показано останні завантажені дані.",
  ...
  "settings.openchamber.about.title": "Про Ivaldi",
  ...
  "settings.page.behavior.title": "Поведінка агента",
  ...
  "settings.gitIdentities.page.state.loadFailed": "Не вдалося завантажити ідентичності Git. Повторіть спробу, щоб оновити цей розділ.",
  ...
  "settings.skills.sidebar.state.loadFailed": "Не вдалося завантажити навички.",
  "settings.skills.page.state.loadFailed": "Не вдалося завантажити цю навичку.",
  "settings.skills.page.state.refreshFailed": "Не вдалося оновити цю навичку. Показано останню завантажену версію.",
  "settings.skills.page.actions.retry": "Повторити",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Додати репозиторій Git як нове джерело каталогу. Ivaldi просканує його на наявність папок, що містять",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Запускати Ivaldi під час входу в систему",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Запускати Ivaldi під час входу в систему",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Показувати Ivaldi у смузі меню macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Показувати Ivaldi у смузі меню",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Потребує перезапуску застосунку. Якщо вимкнено, Ivaldi не створює елемент смуги меню та не запускає пов’язані оновлення сесій, запитів на підтвердження й використання.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Закривати Ivaldi у системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Закривати в системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Залишає Ivaldi запущеним у системному треї, коли головне вікно закрито. Під час згортання вікно залишається на панелі завдань.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Не давати комп’ютеру засинати, поки Ivaldi запущено",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Не давати комп’ютеру засинати, поки Ivaldi запущено",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "Ivaldi попросить пароль після перезапуску, а потім коли сесія логіну спливе: через 12 годин або через 7 днів із «Довіряти цьому пристрою». Залиште порожнім, щоб вимкнути логін.",
  ...
  "settings.openchamber.tools.title": "Інструменти Ivaldi",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Інструмент Ivaldi Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Увімкнути інструмент Ivaldi Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Дозвольте агентам переглядати сторінку в панелі браузера Ivaldi і взаємодіяти з нею: відкривати URL, читати вміст, клікати, вводити текст, гортати та перемикатися між мобільним і десктопним виглядом. Додає невеликий опис інструмента до кожної сесії. Застосовується після перезапуску OpenCode.",
  ...
  "settings.openchamber.keyboardShortcuts.action.reopen_session_tab.label": "Відкрити закриту вкладку сеансу",
  ...
  "settings.remoteInstances.page.description": "Підключіться до іншої машини через SSH і відкрийте там Ivaldi.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Ivaldi на віддаленій машині",
  "settings.remoteInstances.page.section.remoteServerDescription": "Виберіть, як Ivaldi має працювати після SSH-підключення.",
  "settings.remoteInstances.page.section.mainTunnel": "Доступ із цього комп’ютера",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Ivaldi працює на віддаленій машині. Ці налаштування керують лише адресою на цьому комп’ютері, яка веде до неї через SSH-тунель.",
  "settings.remoteInstances.page.section.authentication": "Аутентифікація",
  "settings.remoteInstances.page.section.authenticationDescription": "Додаткові облікові дані для SSH та віддаленого інтерфейсу користувача Ivaldi.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Як розмістити Ivaldi на віддаленій машині, коли цей застосунок запускає його для вас.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Спершу вкажіть віддалений порт. У режимі «Вже запущено» Ivaldi має знати, на якому порту слухає сервер.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Дозволити іншим пристроям у мережі віддаленої машини відкривати цей Ivaldi напряму, без SSH-тунелю. Потрібен пароль UI.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Будь-хто в тій мережі зможе дістатись віддаленого Ivaldi. Його захищає лише пароль UI нижче.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Спершу задайте пароль UI. Без нього віддалений Ivaldi буде відкритий для всіх пристроїв у тій мережі.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Пароль, яким буде захищено віддалений інтерфейс Ivaldi. Ivaldi задасть його серверу, який запускає для вас.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Пароль сервера Ivaldi, який уже працює на віддаленій машині, для входу в нього.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Встановлення Ivaldi",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Оновлення Ivaldi",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Зберігається в автентифікації OpenCode, не Ivaldi. Використовуйте {env:VAR_NAME}, щоб читати ключ зі змінної середовища.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключі надсилаються безпосередньо до OpenCode і ніколи не зберігаються в Ivaldi.",
  ...
  "settings.openchamber.defaults.field.provider": "Провайдер",
  ...
  "settings.openchamber.defaults.field.defaultAssistant": "Асистент за замовчуванням",
  ...
  "settings.github.page.flow.title": "Авторизувати Ivaldi",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Доступно як резервний варіант, якщо автентифікацію Ivaldi видалено",
  ...
  "settings.notifications.page.testNotification.body": "Це тестове сповіщення від Ivaldi.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Локальна розшифровка на сервері Ivaldi. Моделі завантажуються автоматично; ключ API не потрібен.",
  "settings.voice.page.tooltip.localTts": "Локальний синтез на сервері Ivaldi (Kokoro, англійська). Модель завантажується автоматично; ключ API не потрібен.",
  ...
  "settings.voice.page.field.optional": "Додатково",
