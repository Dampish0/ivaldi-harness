...
export const dict: Partial<Record<I18nKey, string>> = {
  ...
  ...permissionModeMessages['zh-TW'],
  ...sharedSettingsMessages['zh-TW'],
  ...
  "profile.setup.title": "該怎麼稱呼你？",
  "profile.setup.description": "為你的 Ivaldi 個人資料選擇一個名字。之後可以修改。",
  "profile.name.label": "你的名字",
  "profile.name.placeholder": "名字或使用者名稱",
  "profile.actions.continue": "繼續",
  "profile.actions.save": "儲存",
  "profile.actions.edit": "編輯個人資料",
  "profile.fallback": "你的個人資料",
  "profile.error.invalid": "請輸入 1 至 64 個字元的名字。",
  ...
  'mobile.connect.welcome.title': '連線至 Ivaldi',
  ...
  'mobile.connect.password.placeholder': 'Ivaldi 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 Ivaldi 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 Ivaldi Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 Ivaldi 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Ivaldi。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Ivaldi，但與此應用程式版本不相容。請更新伺服器上的 Ivaldi 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Ivaldi 伺服器與此應用程式版本不相容。請更新伺服器上的 Ivaldi 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 Ivaldi',
  ...
  'sessions.sidebar.activity.projectsTitle': '專案',
  ...
  'header.sessionTabs.scrollLeftAria': '向左捲動分頁',
  'header.sessionTabs.scrollRightAria': '向右捲動分頁',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 Ivaldi 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 Ivaldi 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 Ivaldi 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Ivaldi 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 Ivaldi 中編輯。請下載後使用其他應用程式開啟。',
  ...
  "directoryExplorerDialog.pathInput.label": "專案資料夾",
  "directoryExplorerDialog.work.description": "將相關聊天和檔案集中到一個專案中。",
  "directoryExplorerDialog.work.existingFolder": "使用現有資料夾",
  "directoryExplorerDialog.work.newProject": "建立新專案",
  "directoryExplorerDialog.work.createProject": "建立專案",
  "directoryExplorerDialog.work.projectName": "專案名稱",
  "directoryExplorerDialog.work.namePlaceholder": "例如：夏季活動",
  "directoryExplorerDialog.work.nameHint": "將使用此名稱建立一個新資料夾。",
  "directoryExplorerDialog.work.nameExists": "同名資料夾已存在。請選擇其他名稱或使用現有資料夾。",
  "directoryExplorerDialog.work.invalidName": "請輸入有效的資料夾名稱，不含斜線或特殊字元。",
  "directoryExplorerDialog.work.saveLocation": "儲存位置",
  "directoryExplorerDialog.work.chooseFolderHint": "選擇包含專案檔案的資料夾。",
  "directoryExplorerDialog.work.selectFolder": "使用此資料夾",
  "directoryExplorerDialog.actions.chooseFolder": "瀏覽資料夾...",
  "directoryExplorerDialog.actions.openingPicker": "開啟中...",
  "directoryExplorerDialog.title": "新增專案",
  "directoryExplorerDialog.description": "開啟一個資料夾作為專案，或輸入新路徑來建立資料夾。",
  ...
  "directoryExplorerDialog.actions.addProject": "新增此資料夾",
  ...
  "directoryExplorerDialog.actions.createAndAdd": "建立並新增資料夾",
  "directoryExplorerDialog.actions.alreadyAdded": "資料夾已新增",
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Ivaldi 需要存取此資料夾。',
  ...
  "directoryExplorerDialog.footer.select": "開啟資料夾",
  ...
  'aboutDialog.openChamberVersionLabel': 'Ivaldi 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Ivaldi 狀態、執行階段健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Ivaldi',
  ...
  'header.actions.openAppMenu': 'Ivaldi 選單',
  'header.actions.openAppMenuAria': '開啟 Ivaldi 選單',
  ...
  'chat.emptyState.opencodeUnreachable': '無法連線 Ivaldi 執行階段',
  'chat.emptyState.startNewChat': '開始新的聊天',
  'chat.work.newChat': '新增聊天',
  'chat.work.startNewFromAnswer': '從此回答開始新聊天',
  'chat.work.keepWorkingUntilComplete': '持續工作直到完成',
  'chat.work.showMore': '顯示更多',
  'chat.work.showFewer': '顯示較少',
  'chat.work.searchChats': '搜尋聊天',
  'chat.work.searchChatsPlaceholder': '搜尋聊天...',
  'chat.work.selectChats': '選取聊天',
  'chat.work.noRecentChats': '沒有最近的聊天',
  'chat.work.untitledChat': '未命名聊天',
  'chat.work.archive.searchPlaceholder': '搜尋已封存聊天',
  'chat.work.archive.countSingle': '{count} 個已封存聊天',
  'chat.work.archive.countPlural': '{count} 個已封存聊天',
  'chat.work.archive.emptyNoArchived': '沒有已封存聊天',
  'chat.work.archive.emptyNoMatches': '沒有符合的已封存聊天',
  'chat.work.archive.deleteProject': '刪除此專案中的所有已封存聊天',
  'chat.work.archive.deleteProjectAria': '刪除 {label} 中的所有已封存聊天',
  'chat.work.scheduledTasks.description': '依排程啟動新聊天並傳送已設定提示詞的工作。',
  'chat.work.scheduledTasks.editorDescription': '選擇此工作何時啟動新聊天並傳送提示詞。',
  'chat.work.scheduledTasks.goalAria': '將此工作作為目標執行直到完成',
  'chat.work.mobile.noProjectsDescription': '新增專案以使用其中的檔案與內容脈絡進行工作。',
  'chat.work.mobile.renameError': '重新命名聊天失敗',
  'chat.work.mobile.editOrderHint': '拖曳控制柄重新排序專案。完成後點一下勾選。',
  'chat.emptyState.draftTitle': 'What are we working on?',
  'chat.emptyState.draftTitleWithProject': 'What are we working on in {project}?',
  'chat.emptyState.workDraftTitle': '我能幫你做什麼？',
  'chat.emptyState.workDraftTitleWithProject': '在 {project} 中我能幫你做什麼？',
  'chat.emptyState.workDraftSubtitle': '需要時，我可以使用你的檔案、網頁、整合服務、MCP 工具、外掛程式和技能。',
  ...
  'chat.draftPresets.researchTopic.label': '研究主題',
  'chat.draftPresets.draftDocument.label': '撰寫文件',
  'chat.draftPresets.analyzeFiles.label': '分析檔案',
  'chat.draftPresets.projectPlan.label': '規劃專案',
  'chat.draftPresets.summarizeProject.label': '摘要專案',
  ...
  'chat.work.draftStarters.add': '新增建議',
  'chat.work.draftStarters.searchPlaceholder': '搜尋動作與技能…',
  'chat.work.draftStarters.empty': '沒有其他可新增的內容',
  'chat.work.draftStarters.sectionBuiltIn': '建議動作',
  'chat.work.draftStarters.sectionCommands': '動作',
  'chat.work.draftStarters.sectionSkills': '技能',
  'chat.work.draftStarters.remove': '移除建議',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'Ivaldi 執行階段在回覆仍在產生時重新啟動。傳送訊息以繼續。',
  ...
  'chat.chatInput.commandChip.removeAria': '移除 {command}',
  'chat.chatInput.commandChip.planLabel': '計畫',
  ...
  'chat.activity.label': '活動',
  'chat.activity.more': '另有 {count} 項...',
  ...
  'chat.permissionCard.replaceAllOccurrences': '取代所有相符項目',
  ...
  'openCodeStatusDialog.title': 'Ivaldi 執行階段狀態',
  'openCodeStatusDialog.description': '查看目前 Ivaldi 執行階段狀態與診斷資訊。',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 Ivaldi，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Ivaldi',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Ivaldi 伺服器之間切換',
  ...
  'multiRun.window.description': 'Ivaldi 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Ivaldi',
  ...
  'onboarding.localSetup.title': '設定 Ivaldi',
  'onboarding.localSetup.description': 'Ivaldi 需要 OpenCode CLI 執行階段才能繼續。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Ivaldi 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': '安裝 Ivaldi 用於本機代理工作階段的執行階段。',
  ...
  'onboarding.localSetup.status.watching': '正在等待 Ivaldi 執行階段',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Ivaldi 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Ivaldi 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Ivaldi 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Ivaldi。請確認位址是否指向 Ivaldi 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本機 Ivaldi 執行階段無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': '本機代理執行階段無法啟動或未安裝。請安裝 OpenCode CLI 執行階段，或改為連接遠端 Ivaldi 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Ivaldi。請確認位址是否指向 Ivaldi 伺服器。',
  ...
  'startup.initRecovery.description': 'Ivaldi 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Ivaldi...',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Ivaldi 開啟。',
  ...
  'openChamberLogo.aria.logo': 'Ivaldi 標誌',
  ...
  'filesView.tree.actions.moreAria': '更多檔案操作',
