import type { SettingsI18nKey } from './en.settings';
...
export const dict = {
  ...
  "profile.setup.title": "What should we call you?",
  "profile.setup.description": "Choose a name for your Ivaldi profile. You can change it later.",
  "profile.name.label": "Your name",
  "profile.name.placeholder": "Name or username",
  "profile.actions.continue": "Continue",
  "profile.actions.save": "Save",
  "profile.actions.edit": "Edit profile",
  "profile.fallback": "Your profile",
  "profile.error.invalid": "Enter a name between 1 and 64 characters.",
  "profile.error.storage": "Could not save your name. Please try again.",
  ...
  'pwa.installPrompt.description': 'Install Ivaldi for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Ivaldi installed',
  ...
  'mobile.connect.welcome.title': 'Connect to Ivaldi',
  ...
  'mobile.connect.password.placeholder': 'Ivaldi password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an Ivaldi connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Ivaldi server.',
  ...
  'sessions.sidebar.header.productMode.work': 'Work',
  'sessions.sidebar.header.productMode.developer': 'Developer',
  ...
  'sessions.sidebar.footer.github.notConnected': 'GitHub not connected',
  'sessions.sidebar.footer.github.disconnect': 'Disconnect GitHub',
  'sessions.sidebar.footer.update.product': 'Update {product}',
  'sessions.sidebar.footer.actions.settings': 'Settings',
  'sessions.sidebar.footer.actions.shortcuts': 'Shortcuts',
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About Ivaldi',
  ...
  'sessions.sidebar.activity.projectsTitle': 'Projects',
  ...
  'header.sessionTabs.scrollLeftAria': 'Scroll tabs left',
  'header.sessionTabs.scrollRightAria': 'Scroll tabs right',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The Ivaldi server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine Ivaldi is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting Ivaldi. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Ivaldi — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in Ivaldi. Download it to open with another app.',
  ...
  'filesView.tree.actions.moreAria': 'More file actions',
  ...
  "directoryExplorerDialog.pathInput.label": "Project folder",
  "directoryExplorerDialog.work.description": "Keep related chats and files together in a project.",
  "directoryExplorerDialog.work.existingFolder": "Use existing folder",
  "directoryExplorerDialog.work.newProject": "Create new project",
  "directoryExplorerDialog.work.createProject": "Create project",
  "directoryExplorerDialog.work.projectName": "Project name",
  "directoryExplorerDialog.work.namePlaceholder": "e.g. Summer campaign",
  "directoryExplorerDialog.work.nameHint": "A new folder will be created with this name.",
  "directoryExplorerDialog.work.nameExists": "A folder with this name already exists. Choose another name or use the existing folder.",
  "directoryExplorerDialog.work.invalidName": "Enter a valid folder name without slashes or special characters.",
  "directoryExplorerDialog.work.saveLocation": "Save in",
  "directoryExplorerDialog.work.chooseFolderHint": "Choose the folder that contains your project files.",
  "directoryExplorerDialog.work.selectFolder": "Use this folder",
  "directoryExplorerDialog.actions.chooseFolder": "Browse folders...",
  "directoryExplorerDialog.actions.openingPicker": "Opening...",
  "directoryExplorerDialog.title": "Add project",
  "directoryExplorerDialog.description": "Open a folder to use as a project, or enter a new folder path to create one.",
  ...
  "directoryExplorerDialog.actions.addProject": "Add this folder",
  ...
  "directoryExplorerDialog.actions.createAndAdd": "Create folder & add",
  "directoryExplorerDialog.actions.alreadyAdded": "Folder already added",
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Ivaldi needs access to this folder.',
  ...
  "directoryExplorerDialog.footer.select": "Open folder",
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Ivaldi state, runtime health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Ivaldi efficiently',
  ...
  'header.actions.openAppMenu': 'Ivaldi menu',
  'header.actions.openAppMenuAria': 'Open Ivaldi menu',
  ...
  'chat.work.startNewFromAnswer': 'New chat from this answer',
  'chat.work.keepWorkingUntilComplete': 'Keep working until complete',
  'chat.work.showMore': 'Show more',
  'chat.work.showFewer': 'Show fewer',
  'chat.work.searchChats': 'Search chats',
  'chat.work.searchChatsPlaceholder': 'Search chats...',
  'chat.work.selectChats': 'Select chats',
  'chat.work.noRecentChats': 'No recent chats',
  'chat.work.untitledChat': 'Untitled chat',
  'chat.work.archive.searchPlaceholder': 'Search archived chats',
  'chat.work.archive.countSingle': '{count} archived chat',
  'chat.work.archive.countPlural': '{count} archived chats',
  'chat.work.archive.emptyNoArchived': 'No archived chats',
  'chat.work.archive.emptyNoMatches': 'No matching archived chats',
  'chat.work.archive.deleteProject': 'Delete all archived chats in this project',
  'chat.work.archive.deleteProjectAria': 'Delete all archived chats in {label}',
  'chat.work.scheduledTasks.description': 'Tasks that start a new chat and send the configured prompt on your schedule.',
  'chat.work.scheduledTasks.editorDescription': 'Choose when this task should start a new chat and send its prompt.',
  'chat.work.scheduledTasks.goalAria': 'Run this task as a goal until it is complete',
  'chat.work.mobile.noProjectsDescription': 'Add a project to work with its files and context.',
  'chat.work.mobile.renameError': 'Failed to rename chat',
  'chat.work.mobile.editOrderHint': 'Drag the handle to reorder projects. Tap the check to finish.',
  'chat.emptyState.draftTitle': 'What are we working on?',
  'chat.emptyState.draftTitleWithProject': 'What are we working on in {project}?',
  'chat.emptyState.workDraftTitle': 'What can I help with?',
  'chat.emptyState.workDraftTitleWithProject': 'What can I help with in {project}?',
  'chat.emptyState.workDraftSubtitle': 'I can use your files, the web, integrations, MCP tools, plugins, and skills when they help.',
  ...
  'chat.draftPresets.researchTopic.label': 'Research a topic',
  'chat.draftPresets.draftDocument.label': 'Draft a document',
  'chat.draftPresets.analyzeFiles.label': 'Analyze files',
  'chat.draftPresets.projectPlan.label': 'Plan a project',
  'chat.draftPresets.summarizeProject.label': 'Summarize a project',
  ...
  'chat.work.draftStarters.add': 'Add suggestion',
  'chat.work.draftStarters.searchPlaceholder': 'Search actions and skills…',
  'chat.work.draftStarters.empty': 'Nothing else to add',
  'chat.work.draftStarters.sectionBuiltIn': 'Suggested actions',
  'chat.work.draftStarters.sectionCommands': 'Actions',
  'chat.work.draftStarters.sectionSkills': 'Skills',
  'chat.work.draftStarters.remove': 'Remove suggestion',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'The Ivaldi runtime restarted while a response was still running. Send a message to continue.',
  ...
  'chat.chatInput.placeholder.chatCompactWork': 'Use @ / # for helpers',
  ...
  'chat.chatInput.commandChip.removeAria': 'Remove {command}',
  'chat.chatInput.commandChip.planLabel': 'Plan',
  'chat.chatInput.commandChip.goalLabel': 'Goal',
  ...
  'chat.activity.label': 'Activity',
  'chat.activity.more': '+{count} more...',
  ...
  'chat.permissionCard.replaceAllOccurrences': 'Replace all occurrences',
  ...
  'openCodeStatusDialog.title': 'Ivaldi Runtime Status',
  'openCodeStatusDialog.description': 'Inspect the current Ivaldi runtime status and diagnostics.',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Ivaldi from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Ivaldi',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Ivaldi servers',
  ...
  'multiRun.window.description': 'Ivaldi Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Ivaldi',
  ...
  'onboarding.localSetup.title': 'Setting Up Ivaldi',
  'onboarding.localSetup.description': 'Ivaldi needs the OpenCode CLI runtime to continue.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Ivaldi does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'Install the runtime Ivaldi uses for local agent sessions.',
  ...
  'onboarding.localSetup.status.watching': 'Waiting for the Ivaldi runtime',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Ivaldi settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Ivaldi server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Ivaldi server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Ivaldi version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Ivaldi but is not compatible with this app version. Update Ivaldi on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Ivaldi. Verify the address points to an Ivaldi server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local Ivaldi Runtime Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'The local agent runtime could not be started or is not installed. Install the OpenCode CLI runtime or connect to a remote Ivaldi server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Ivaldi. Verify the address points to an Ivaldi server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Ivaldi server at "{host}" is not compatible with this app version. Update Ivaldi on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Ivaldi could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Ivaldi...',
  ...
  'mobileUpdate.toast.available.title': 'Ivaldi update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Ivaldi open.',
...
export type I18nKey = keyof typeof dict | SettingsI18nKey;
