...
export const dict: Partial<Record<I18nKey, string>> = {
  ...
  ...permissionModeMessages.ja,
  ...sharedSettingsMessages.ja,
  ...
  "profile.setup.title": "どのようにお呼びしますか？",
  "profile.setup.description": "Ivaldiのプロフィール名を決めましょう。後から変更できます。",
  "profile.name.label": "お名前",
  "profile.name.placeholder": "名前またはユーザー名",
  "profile.actions.continue": "続ける",
  "profile.actions.save": "保存",
  "profile.actions.edit": "プロフィールを編集",
  "profile.fallback": "あなたのプロフィール",
  "profile.error.invalid": "1〜64文字の名前を入力してください。",
  ...
  'mobile.connect.welcome.title': 'Ivaldi に接続',
  ...
  'mobile.connect.password.placeholder': 'Ivaldi のパスワード',
  ...
  'mobile.connect.relay.badge': 'Ivaldi Relay 経由',
  ...
  'mobile.connect.error.unreachable': 'その Ivaldi サーバーに接続できませんでした。',
  ...
  'mobile.connect.scan.invalid': 'その QR コードは Ivaldi の接続コードではありません。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'Ivaldiについて',
  ...
  'sessions.sidebar.activity.projectsTitle': 'プロジェクト',
  ...
  'header.sessionTabs.scrollLeftAria': 'タブを左にスクロール',
  'header.sessionTabs.scrollRightAria': 'タブを右にスクロール',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'このアプリが接続している Ivaldi サーバーはウォークスルー API に応答しませんでした。つまりアプリより古いバージョンです。サーバーを 1.18 以降に更新してから再読み込みしてください。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} は Ivaldi が動いているマシン上にあり、そこへの接続を開けませんでした。あなたのマシンの内容はここには表示されません。',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'これらは Ivaldi を動かしているマシン上で動作しています。開くにはデスクトップアプリが必要です。',
  ...
  'contextPanel.browser.trustNotice': 'ここで開かれたページは Ivaldi への完全なアクセス権を持ちます — 検査とスクリーンショットに必要です。信頼できるサイトのみを開いてください: 悪意のあるページがデータを読み取ったりあなたの代わりに行動したりする可能性があります。',
  ...
  'filesView.editor.binaryFileDescription': 'このファイルはバイナリのため、Ivaldiでは編集できません。別のアプリで開くにはダウンロードしてください。',
  ...
  'filesView.tree.actions.moreAria': 'その他のファイル操作',
  ...
  "directoryExplorerDialog.pathInput.label": "プロジェクトフォルダー",
  "directoryExplorerDialog.work.description": "関連するチャットとファイルをプロジェクトにまとめます。",
  "directoryExplorerDialog.work.existingFolder": "既存のフォルダーを使う",
  "directoryExplorerDialog.work.newProject": "新しいプロジェクトを作成",
  "directoryExplorerDialog.work.createProject": "プロジェクトを作成",
  "directoryExplorerDialog.work.projectName": "プロジェクト名",
  "directoryExplorerDialog.work.namePlaceholder": "例：夏のキャンペーン",
  "directoryExplorerDialog.work.nameHint": "この名前で新しいフォルダーが作成されます。",
  "directoryExplorerDialog.work.nameExists": "同じ名前のフォルダーが既にあります。別の名前を選ぶか、既存のフォルダーを使ってください。",
  "directoryExplorerDialog.work.invalidName": "スラッシュや特殊文字を含まない有効なフォルダー名を入力してください。",
  "directoryExplorerDialog.work.saveLocation": "保存先",
  "directoryExplorerDialog.work.chooseFolderHint": "プロジェクトのファイルが入っているフォルダーを選択してください。",
  "directoryExplorerDialog.work.selectFolder": "このフォルダーを使う",
  "directoryExplorerDialog.actions.chooseFolder": "フォルダーを参照...",
  "directoryExplorerDialog.actions.openingPicker": "開いています...",
  "directoryExplorerDialog.title": "プロジェクトを追加",
  "directoryExplorerDialog.description": "フォルダーを開いてプロジェクトにするか、新しいパスを入力してフォルダーを作成します。",
  ...
  "directoryExplorerDialog.actions.addProject": "このフォルダーを追加",
  ...
  "directoryExplorerDialog.actions.createAndAdd": "フォルダーを作成して追加",
  "directoryExplorerDialog.actions.alreadyAdded": "追加済みのフォルダー",
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Ivaldi がこのフォルダにアクセスする必要があります。',
  ...
  "directoryExplorerDialog.footer.select": "フォルダーを開く",
  ...
  'aboutDialog.openChamberVersionLabel': 'Ivaldi バージョン {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Ivaldi の状態、ランタイムの状態、ディレクトリ、プロジェクトが含まれます。',
  ...
  'helpDialog.description': 'これらのキーボードショートカットを使ってIvaldiを効率的に操作できます',
  ...
  'header.actions.openAppMenu': 'Ivaldiメニュー',
  'header.actions.openAppMenuAria': 'Ivaldiメニューを開く',
  ...
  'chat.emptyState.opencodeUnreachable': 'Ivaldi ランタイムに接続できません',
  'chat.emptyState.startNewChat': '新しいチャットを開始',
  'chat.work.newChat': '新しいチャット',
  'chat.work.startNewFromAnswer': 'この回答から新しいチャットを開始',
  'chat.work.keepWorkingUntilComplete': '完了するまで続ける',
  'chat.work.showMore': 'さらに表示',
  'chat.work.showFewer': '表示を減らす',
  'chat.work.searchChats': 'チャットを検索',
  'chat.work.searchChatsPlaceholder': 'チャットを検索...',
  'chat.work.selectChats': 'チャットを選択',
  'chat.work.noRecentChats': '最近のチャットはありません',
  'chat.work.untitledChat': '無題のチャット',
  'chat.work.archive.searchPlaceholder': 'アーカイブ済みチャットを検索',
  'chat.work.archive.countSingle': 'アーカイブ済みチャット {count} 件',
  'chat.work.archive.countPlural': 'アーカイブ済みチャット {count} 件',
  'chat.work.archive.emptyNoArchived': 'アーカイブ済みチャットはありません',
  'chat.work.archive.emptyNoMatches': '一致するアーカイブ済みチャットはありません',
  'chat.work.archive.deleteProject': 'このプロジェクトのアーカイブ済みチャットをすべて削除',
  'chat.work.archive.deleteProjectAria': '{label} のアーカイブ済みチャットをすべて削除',
  'chat.work.scheduledTasks.description': 'スケジュールに従って新しいチャットを開始し、設定したプロンプトを送信するタスクです。',
  'chat.work.scheduledTasks.editorDescription': 'このタスクが新しいチャットを開始してプロンプトを送信するタイミングを選択します。',
  'chat.work.scheduledTasks.goalAria': 'このタスクを完了するまで目標として実行',
  'chat.work.mobile.noProjectsDescription': 'プロジェクトを追加して、そのファイルやコンテキストを使って作業できます。',
  'chat.work.mobile.renameError': 'チャット名を変更できませんでした',
  'chat.work.mobile.editOrderHint': 'ハンドルをドラッグしてプロジェクトを並べ替えます。完了したらチェックをタップします。',
  'chat.emptyState.draftTitle': '何に取り組みますか？',
  'chat.emptyState.draftTitleWithProject': '{project}で何に取り組みますか？',
  'chat.emptyState.workDraftTitle': '何をお手伝いしましょうか？',
  'chat.emptyState.workDraftTitleWithProject': '{project}で何をお手伝いしましょうか？',
  'chat.emptyState.workDraftSubtitle': '必要に応じて、ファイル、Web、連携機能、MCPツール、プラグイン、スキルを利用できます。',
  ...
  'chat.draftPresets.researchTopic.label': 'トピックを調査',
  'chat.draftPresets.draftDocument.label': '文書を作成',
  'chat.draftPresets.analyzeFiles.label': 'ファイルを分析',
  'chat.draftPresets.projectPlan.label': 'プロジェクトを計画',
  'chat.draftPresets.summarizeProject.label': 'プロジェクトを要約',
  ...
  'chat.work.draftStarters.add': '候補を追加',
  'chat.work.draftStarters.searchPlaceholder': 'アクションとスキルを検索…',
  'chat.work.draftStarters.empty': '追加できる項目はありません',
  'chat.work.draftStarters.sectionBuiltIn': 'おすすめのアクション',
  'chat.work.draftStarters.sectionCommands': 'アクション',
  'chat.work.draftStarters.sectionSkills': 'スキル',
  'chat.work.draftStarters.remove': '候補を削除',
  ...
  'chat.toast.opencodeRestartInterrupted.description': '応答の生成中に Ivaldi ランタイムが再起動しました。続行するにはメッセージを送信してください。',
  ...
  'chat.chatInput.commandChip.removeAria': '{command} を削除',
  'chat.chatInput.commandChip.planLabel': '計画',
  'chat.chatInput.commandChip.goalLabel': '目標',
  ...
  'chat.activity.label': 'アクティビティ',
  'chat.activity.more': 'さらに{count}件...',
  ...
  'chat.permissionCard.replaceAllOccurrences': 'すべての出現箇所を置換',
  ...
  'openCodeStatusDialog.title': 'Ivaldi ランタイムの状態',
  'openCodeStatusDialog.description': '現在の Ivaldi ランタイムの状態と診断情報を確認します。',
  ...
  'sessionAuth.error.networkDescription': 'UI セッションを確認できませんでした。ローカルネットワーク上の別のデバイスから Ivaldi を開く場合は、デスクトップアプリで Desktop Network Access を有効にし、設定に表示される LAN アドレスを使用してください。',
  ...
  'sessionAuth.locked.unlockTitle': 'Ivaldiのロックを解除',
  ...
  'desktopHostSwitcher.description': 'ローカルとリモートのIvaldiサーバーを切り替えます',
  ...
  'multiRun.window.description': 'Ivaldiマルチランウィンドウ。',
  ...
  'onboarding.chooser.title': 'Ivaldiへようこそ',
  ...
  'onboarding.localSetup.title': 'Ivaldi のセットアップ',
  'onboarding.localSetup.description': '続行するには Ivaldi が使用する OpenCode CLI ランタイムが必要です。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'IvaldiがOpenCodeを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'Ivaldi がローカルのエージェントセッションで使用するランタイムをインストールします。',
  ...
  'onboarding.localSetup.status.watching': 'Ivaldi ランタイムを待機中',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Ivaldi設定に保存し、OpenCode設定を再読み込みします。',
  ...
  'onboarding.remoteConnection.description': '接続するIvaldiサーバーのアドレスを入力します。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'ヒント: URLがIvaldiサーバーを指しているか確認するか、サーバー管理者に問い合わせてください。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'このインスタンスは異なるバージョンのIvaldiを実行しています。接続は可能ですが、正常に動作しない場合は両方のアプリを更新してください。',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'サーバーはIvaldiを実行していますが、このアプリバージョンと互換性がありません。サーバーのIvaldiを更新してから再試行してください。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'サーバーは応答しましたが、Ivaldiを実行していません。アドレスがIvaldiサーバーを指していることを確認してください。',
  'onboarding.remoteConnection.probe.unreachableMessage': 'サーバーに到達できません。ネットワーク接続を確認し、サーバーアドレスを確認してください。',
  'onboarding.desktopRecovery.localUnavailable.title': 'ローカル Ivaldi ランタイムが利用できません',
  'onboarding.desktopRecovery.localUnavailable.description': 'ローカルのエージェントランタイムを起動できないか、インストールされていません。OpenCode CLI ランタイムをインストールするか、リモートの Ivaldi サーバーに接続してください。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」のサーバーはIvaldiを実行していません。アドレスがIvaldiサーバーを指していることを確認してください。',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'サーバーの更新が必要',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」のIvaldiサーバーはこのアプリバージョンと互換性がありません。サーバーのIvaldiを更新してから再試行してください。',
  ...
  'startup.initRecovery.description': 'Ivaldiが初期化を完了できませんでした。サーバーが実行中であることを確認してから再試行してください。',
  ...
  'updateDialog.header.updating': 'Ivaldiを更新中...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Ivaldiを開いたままにしてください。',
  ...
  'openChamberLogo.aria.logo': 'Ivaldiロゴ',
